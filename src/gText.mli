...
class iter :
  ...
  object
    ...
    method get_slice : stop:textiter -> string
    method get_tags : tag list
    method get_text : stop:textiter -> string
    method get_toggled_tags : bool -> texttag obj list
    method get_visible_line_index : int
    method get_visible_line_offset : int
    method get_visible_slice : stop:textiter -> string
    method get_visible_text : stop:textiter -> string
    method has_tag : texttag obj -> bool
    method in_range : start:textiter -> stop:textiter -> int
...
class buffer :
  ...
  object
    ...
    method insert_range_interactive :
      ...
      start:textiter ->
      stop:textiter -> ?default_editable:bool -> unit -> bool
    method move_mark : mark -> where:textiter -> unit
    method move_mark_by_name : string -> where:textiter -> unit
