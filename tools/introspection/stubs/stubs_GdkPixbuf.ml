...
module PixbufSimpleAnimIter = struct
  end
module PixbufSimpleAnimClass = struct
  end
...
module PixbufNonAnim = struct
  end
module PixbufModulePattern = struct
  end
module PixbufModule = struct
  end
module PixbufLoaderClass = struct
  end
...
module PixbufAnimationIterClass = struct
  end
...
module PixbufAnimationClass = struct
  end
module PixbufAnimation = struct
  external unref: [>`gdkpixbufanimation] obj -> unit = "ml_gdk_pixbuf_animation_unref"
  external ref: [>`gdkpixbufanimation] obj -> [<`gdkpixbufanimation] obj = "ml_gdk_pixbuf_animation_ref"
...
module Pixbuf = struct
  external unref: [>`gdkpixbuf] obj -> unit = "ml_gdk_pixbuf_unref"
  external set_option: [>`gdkpixbuf] obj -> string -> string -> bool = "ml_gdk_pixbuf_set_option"
  external ref: [>`gdkpixbuf] obj -> [<`gdkpixbuf] obj = "ml_gdk_pixbuf_ref"
  ...
  external get_pixels: [>`gdkpixbuf] obj -> string = "ml_gdk_pixbuf_get_pixels"
...
(* Global functions *)
external pixbuf_error_quark: unit -> int32 = "ml_gdk_pixbuf_error_quark"
