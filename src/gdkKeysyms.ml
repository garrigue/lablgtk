...
let _filledrectbullet ~_: keysym = 0xadb
let _filledlefttribullet ~_: keysym = 0xadc
let _filledrighttribullet ~_: keysym = 0xadd
let _emfilledcircle : keysym = 0xade
let _emfilledrect : keysym = 0xadf
let _enopencircbullet ~_: keysym = 0xae0
let _enopensquarebullet ~_: keysym = 0xae1
let _openrectbullet ~_: keysym = 0xae2
let _opentribulletup : keysym = 0xae3
let _opentribulletdown : keysym = 0xae4
let _openstar : keysym = 0xae5
let _enfilledcircbullet ~_: keysym = 0xae6
let _enfilledsqbullet ~_: keysym = 0xae7
...
let _hebrew_dalet ~_: keysym = 0xce3
