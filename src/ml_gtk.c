...
#define GtkAdjustment_val(val) cast(GTK_ADJUSTMENT,Pointer_val(val))
...
gfloat gtk_adjustment_get_value( GtkAdjustment* adj )
{
  return adj->value;
}
ML_1 (gtk_adjustment_get_value, GtkAdjustment_val, copy_double)

/* gtktooltips.h */

#define GtkWidget_val(val) cast(GTK_WIDGET,Pointer_val(val))
#define Val_GtkWidget(w) Val_GtkObject((GtkObject*)w)

#define GtkTooltips_val(val) cast(GTK_TOOLTIPS,Pointer_val(val))
...
#define GtkContainer_val(val) cast(GTK_CONTAINER,Pointer_val(val))
...
#define GtkAlignment_val(val) cast(GTK_ALIGNMENT,Pointer_val(val))
...
#define GtkFrame_val(val) cast(GTK_FRAME,Pointer_val(val))
...
#define GtkAspectFrame_val(val) cast(GTK_ASPECT_FRAME,Pointer_val(val))
...
#define GtkItem_val(val) cast(GTK_ITEM,Pointer_val(val))
...
#define GtkMenuItem_val(val) cast(GTK_MENU_ITEM,Pointer_val(val))
...
#define GtkCheckMenuItem_val(val) cast(GTK_CHECK_MENU_ITEM,Pointer_val(val))
...
#define GtkRadioMenuItem_val(val) cast(GTK_RADIO_MENU_ITEM,Pointer_val(val))
...
#define GtkTreeItem_val(val) cast(GTK_TREE_ITEM,Pointer_val(val))
...
#define GtkViewport_val(val) cast(GTK_VIEWPORT,Pointer_val(val))
...
#define GtkDialog_val(val) cast(GTK_DIALOG,Pointer_val(val))
...
#define GtkFileSelection_val(val) cast(GTK_FILE_SELECTION,Pointer_val(val))
...
#define GtkWindow_val(val) cast(GTK_WINDOW,Pointer_val(val))
...
#define GtkColorSelection_val(val) cast(GTK_COLOR_SELECTION,Pointer_val(val))
...
#define GtkBox_val(val) cast(GTK_BOX,Pointer_val(val))
...
#define GtkButtonBox_val(val) cast(GTK_BUTTON_BOX,Pointer_val(val))
...
#define GtkList_val(val) cast(GTK_LIST,Pointer_val(val))
...
#define GtkCombo_val(val) cast(GTK_COMBO,Pointer_val(val))
...
#define GtkStatusbar_val(val) cast(GTK_STATUSBAR,Pointer_val(val))
...
#define GtkGammaCurve_val(val) cast(GTK_GAMMA_CURVE,Pointer_val(val))
ML_0 (gtk_gamma_curve_new, Val_GtkWidget)
Make_Extractor (gtk_gamma_curve_get, GtkGammaCurve_val, gamma, copy_double)

/* gtkbutton.h */

#define GtkButton_val(val) cast(GTK_BUTTON,Pointer_val(val))
...
#define GtkOptionMenu_val(val) cast(GTK_OPTION_MENU,Pointer_val(val))
...
#define GtkToggleButton_val(val) cast(GTK_TOGGLE_BUTTON,Pointer_val(val))
...
#define GtkCheckButton_val(val) cast(GTK_CHECK_BUTTON,Pointer_val(val))
ML_0 (gtk_check_button_new, Val_GtkWidget)
ML_1 (gtk_check_button_new_with_label, String_val, Val_GtkWidget)

/* gtkradiobutton.h */

#define GtkRadioButton_val(val) cast(GTK_RADIO_BUTTON,Pointer_val(val))
...
#define GtkClist_val(val) cast(GTK_CLIST,Pointer_val(val))
...
#define GtkFixed_val(val) cast(GTK_FIXED,Pointer_val(val))
...
#define GtkMenuShell_val(val) cast(GTK_MENU_SHELL,Pointer_val(val))
...
#define GtkMenu_val(val) cast(GTK_MENU,Pointer_val(val))
...
#define GtkMenuBar_val(val) cast(GTK_MENU_BAR,Pointer_val(val))
ML_0 (gtk_menu_bar_new, Val_GtkWidget)

/* gtknotebook.h */

#define GtkNotebook_val(val) cast(GTK_NOTEBOOK,Pointer_val(val))
...
#define GtkPaned_val(val) cast(GTK_PANED,Pointer_val(val))
...
#define GtkScrolledWindow_val(val) cast(GTK_SCROLLED_WINDOW,Pointer_val(val))
...
#define GtkTable_val(val) cast(GTK_TABLE,Pointer_val(val))
...
#define GtkToolbar_val(val) cast(GTK_TOOLBAR,Pointer_val(val))
...
#define GtkTree_val(val) cast(GTK_TREE,Pointer_val(val))
...
#define GtkDrawingArea_val(val) cast(GTK_DRAWING_AREA,Pointer_val(val))
ML_0 (gtk_drawing_area_new, Val_GtkWidget)
ML_3 (gtk_drawing_area_size, GtkDrawingArea_val, Int_val, Int_val, Unit)

/* gtkeditable.h */

#define GtkEditable_val(val) cast(GTK_EDITABLE,Pointer_val(val))
...
#define GtkEntry_val(val) cast(GTK_ENTRY,Pointer_val(val))
...
#define GtkSpinButton_val(val) cast(GTK_SPIN_BUTTON,Pointer_val(val))
...
#define GtkText_val(val) cast(GTK_TEXT,Pointer_val(val))
...
#define GtkMisc_val(val) cast(GTK_MISC,Pointer_val(val))
...
#define GtkLabel_val(val) cast(GTK_LABEL,Pointer_val(val))
...
#define GtkTipsQuery_val(val) cast(GTK_TIPS_QUERY,Pointer_val(val))
...
#define GtkPixmap_val(val) cast(GTK_PIXMAP,Pointer_val(val))
...
#define GtkProgressBar_val(val) cast(GTK_PROGRESS_BAR,Pointer_val(val))
...
#define GtkRange_val(val) cast(GTK_RANGE,Pointer_val(val))
...
#define GtkScale_val(val) cast(GTK_SCALE,Pointer_val(val))
...
#define GtkRuler_val(val) cast(GTK_RULER,Pointer_val(val))
