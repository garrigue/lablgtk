...
/* Module Module */
ML_1(g_module_name,GModule_val, Val_string)
ML_1(g_module_make_resident,GModule_val, Unit)
ML_1(g_module_close,GModule_val, Val_bool)
/* end of Module */
/* Global functions */
ML_0(g_module_supported,Val_bool)
ML_0(g_module_error,Val_string)
ML_2(g_module_build_path,String_val, String_val, Val_string_new)
