...
ML_1(g_unix_mount_point_get_options,GUnixMountPoint_val, Val_string)
...
/* Module TlsPassword */
ML_2(g_tls_password_set_warning,GTlsPassword_val, String_val, Unit)
ML_3(g_tls_password_set_value,GTlsPassword_val, String_val, Int_val, Unit)
ML_2(g_tls_password_set_description,GTlsPassword_val, String_val, Unit)
ML_1(g_tls_password_get_warning,GTlsPassword_val, Val_string)
ML_1(g_tls_password_get_description,GTlsPassword_val, Val_string)
/* end of TlsPassword */
/* Module TlsInteraction */
/* end of TlsInteraction */
/* Module TlsDatabase */
ML_2(g_tls_database_create_certificate_handle,GTlsDatabase_val, GTlsCertificate_val, Val_string_new)
/* end of TlsDatabase */
/* Module TlsConnection */
ML_2(g_tls_connection_set_require_close_notify,GTlsConnection_val, Bool_val, Unit)
ML_2(g_tls_connection_set_interaction,GTlsConnection_val, Option_val(arg2,GTlsInteraction_val,NULL) Ignore, Unit)
ML_2(g_tls_connection_set_database,GTlsConnection_val, GTlsDatabase_val, Unit)
...
ML_1(g_tls_connection_get_interaction,GTlsConnection_val, Val_GTlsInteraction)
ML_1(g_tls_connection_get_database,GTlsConnection_val, Val_GTlsDatabase)
...
ML_1(g_static_resource_init,GStaticResource_val, Unit)
ML_1(g_static_resource_get_resource,GStaticResource_val, Val_GResource)
ML_1(g_static_resource_fini,GStaticResource_val, Unit)
/* end of StaticResource */
/* Module SrvTarget */
...
ML_1(g_socket_connection_is_connected,GSocketConnection_val, Val_bool)
...
ML_2(g_socket_set_ttl,GSocket_val, Int_val, Unit)
ML_2(g_socket_set_timeout,GSocket_val, Int_val, Unit)
ML_2(g_socket_set_multicast_ttl,GSocket_val, Int_val, Unit)
ML_2(g_socket_set_multicast_loopback,GSocket_val, Bool_val, Unit)
ML_2(g_socket_set_listen_backlog,GSocket_val, Int_val, Unit)
ML_2(g_socket_set_keepalive,GSocket_val, Bool_val, Unit)
ML_2(g_socket_set_broadcast,GSocket_val, Bool_val, Unit)
...
ML_1(g_socket_get_ttl,GSocket_val, Val_int)
ML_1(g_socket_get_timeout,GSocket_val, Val_int)
ML_1(g_socket_get_multicast_ttl,GSocket_val, Val_int)
ML_1(g_socket_get_multicast_loopback,GSocket_val, Val_bool)
...
ML_1(g_socket_get_broadcast,GSocket_val, Val_bool)
ML_1(g_socket_get_blocking,GSocket_val, Val_bool)
ML_1(g_socket_get_available_bytes,GSocket_val, Val_int)
...
ML_2(g_simple_async_result_set_check_cancellable,GSimpleAsyncResult_val, Option_val(arg2,GCancellable_val,NULL) Ignore, Unit)
...
/* Module SimpleAction */
ML_2(g_simple_action_set_state,GSimpleAction_val, GVariant_val, Unit)
ML_2(g_simple_action_set_enabled,GSimpleAction_val, Bool_val, Unit)
/* end of SimpleAction */
/* Module SettingsSchemaSource */
ML_1(g_settings_schema_source_unref,GSettingsSchemaSource_val, Unit)
ML_1(g_settings_schema_source_ref,GSettingsSchemaSource_val, Val_GSettingsSchemaSource_new)
ML_3(g_settings_schema_source_lookup,GSettingsSchemaSource_val, String_val, Bool_val, Val_GSettingsSchema_new)
ML_0(g_settings_schema_source_get_default,Val_GSettingsSchemaSource)
/* end of SettingsSchemaSource */
/* Module SettingsSchema */
ML_1(g_settings_schema_unref,GSettingsSchema_val, Unit)
ML_1(g_settings_schema_ref,GSettingsSchema_val, Val_GSettingsSchema_new)
ML_1(g_settings_schema_get_path,GSettingsSchema_val, Val_string)
ML_1(g_settings_schema_get_id,GSettingsSchema_val, Val_string)
/* end of SettingsSchema */
/* Module Settings */
ML_3(g_settings_set_value,GSettings_val, String_val, GVariant_val, Val_bool)
ML_3(g_settings_set_uint,GSettings_val, String_val, Int_val, Val_bool)
...
ML_2(g_settings_get_uint,GSettings_val, String_val, Val_int)
...
/* end of Settings */
/* Module Resource */
ML_1(g_resource_unref,GResource_val, Unit)
ML_1(g_resource_ref,GResource_val, Val_GResource_new)
ML_1(g_resources_unregister,GResource_val, Unit)
ML_1(g_resources_register,GResource_val, Unit)
/* end of Resource */
/* Module Resolver */
...
/* Module MenuModel */
ML_2(g_menu_model_iterate_item_links,GMenuModel_val, Int_val, Val_GMenuLinkIter_new)
ML_2(g_menu_model_iterate_item_attributes,GMenuModel_val, Int_val, Val_GMenuAttributeIter_new)
ML_4(g_menu_model_items_changed,GMenuModel_val, Int_val, Int_val, Int_val, Unit)
ML_1(g_menu_model_is_mutable,GMenuModel_val, Val_bool)
ML_1(g_menu_model_get_n_items,GMenuModel_val, Val_int)
ML_3(g_menu_model_get_item_link,GMenuModel_val, Int_val, String_val, Val_GMenuModel_new)
ML_4(g_menu_model_get_item_attribute_value,GMenuModel_val, Int_val, String_val, Option_val(arg4,GVariantType_val,NULL) Ignore, Val_GVariant_new)
/* end of MenuModel */
/* Module MenuLinkIter */
ML_1(g_menu_link_iter_next,GMenuLinkIter_val, Val_bool)
ML_1(g_menu_link_iter_get_value,GMenuLinkIter_val, Val_GMenuModel_new)
ML_1(g_menu_link_iter_get_name,GMenuLinkIter_val, Val_string)
/* end of MenuLinkIter */
/* Module MenuItem */
ML_2(g_menu_item_set_submenu,GMenuItem_val, Option_val(arg2,GMenuModel_val,NULL) Ignore, Unit)
ML_2(g_menu_item_set_section,GMenuItem_val, Option_val(arg2,GMenuModel_val,NULL) Ignore, Unit)
ML_3(g_menu_item_set_link,GMenuItem_val, String_val, Option_val(arg3,GMenuModel_val,NULL) Ignore, Unit)
ML_2(g_menu_item_set_label,GMenuItem_val, Option_val(arg2,String_val,NULL) Ignore, Unit)
ML_2(g_menu_item_set_detailed_action,GMenuItem_val, String_val, Unit)
ML_3(g_menu_item_set_attribute_value,GMenuItem_val, String_val, Option_val(arg3,GVariant_val,NULL) Ignore, Unit)
ML_3(g_menu_item_set_action_and_target_value,GMenuItem_val, Option_val(arg2,String_val,NULL) Ignore, Option_val(arg3,GVariant_val,NULL) Ignore, Unit)
/* end of MenuItem */
/* Module MenuAttributeIter */
ML_1(g_menu_attribute_iter_next,GMenuAttributeIter_val, Val_bool)
ML_1(g_menu_attribute_iter_get_value,GMenuAttributeIter_val, Val_GVariant_new)
ML_1(g_menu_attribute_iter_get_name,GMenuAttributeIter_val, Val_string)
/* end of MenuAttributeIter */
/* Module Menu */
ML_2(g_menu_remove,GMenu_val, Int_val, Unit)
ML_3(g_menu_prepend_submenu,GMenu_val, Option_val(arg2,String_val,NULL) Ignore, GMenuModel_val, Unit)
ML_3(g_menu_prepend_section,GMenu_val, Option_val(arg2,String_val,NULL) Ignore, GMenuModel_val, Unit)
ML_2(g_menu_prepend_item,GMenu_val, GMenuItem_val, Unit)
ML_3(g_menu_prepend,GMenu_val, Option_val(arg2,String_val,NULL) Ignore, Option_val(arg3,String_val,NULL) Ignore, Unit)
ML_4(g_menu_insert_submenu,GMenu_val, Int_val, Option_val(arg3,String_val,NULL) Ignore, GMenuModel_val, Unit)
ML_4(g_menu_insert_section,GMenu_val, Int_val, Option_val(arg3,String_val,NULL) Ignore, GMenuModel_val, Unit)
ML_3(g_menu_insert_item,GMenu_val, Int_val, GMenuItem_val, Unit)
ML_4(g_menu_insert,GMenu_val, Int_val, Option_val(arg3,String_val,NULL) Ignore, Option_val(arg4,String_val,NULL) Ignore, Unit)
ML_1(g_menu_freeze,GMenu_val, Unit)
ML_3(g_menu_append_submenu,GMenu_val, Option_val(arg2,String_val,NULL) Ignore, GMenuModel_val, Unit)
ML_3(g_menu_append_section,GMenu_val, Option_val(arg2,String_val,NULL) Ignore, GMenuModel_val, Unit)
ML_2(g_menu_append_item,GMenu_val, GMenuItem_val, Unit)
ML_3(g_menu_append,GMenu_val, Option_val(arg2,String_val,NULL) Ignore, Option_val(arg3,String_val,NULL) Ignore, Unit)
/* end of Menu */
...
ML_1(g_inet_socket_address_get_scope_id,GInetSocketAddress_val, Val_int32)
ML_1(g_inet_socket_address_get_port,GInetSocketAddress_val, Val_int)
ML_1(g_inet_socket_address_get_flowinfo,GInetSocketAddress_val, Val_int32)
...
ML_1(g_inet_address_mask_to_string,GInetAddressMask_val, Val_string_new)
ML_2(g_inet_address_mask_matches,GInetAddressMask_val, GInetAddress_val, Val_bool)
ML_1(g_inet_address_mask_get_length,GInetAddressMask_val, Val_int)
ML_1(g_inet_address_mask_get_address,GInetAddressMask_val, Val_GInetAddress)
ML_2(g_inet_address_mask_equal,GInetAddressMask_val, GInetAddressMask_val, Val_bool)
/* end of InetAddressMask */
/* Module InetAddress */
...
ML_2(g_inet_address_equal,GInetAddress_val, GInetAddress_val, Val_bool)
/* end of InetAddress */
/* Module IOStream */
...
/* Module IOModuleScope */
ML_1(g_io_module_scope_free,GIOModuleScope_val, Unit)
ML_2(g_io_module_scope_block,GIOModuleScope_val, String_val, Unit)
/* end of IOModuleScope */
/* Module IOModule */
...
ML_3(g_file_info_set_attribute_object,GFileInfo_val, String_val, GObject_val, Unit)
...
ML_2(g_file_info_get_attribute_object,GFileInfo_val, String_val, Val_GObject)
...
ML_1(g_file_attribute_matcher_to_string,GFileAttributeMatcher_val, Val_string_new)
ML_2(g_file_attribute_matcher_subtract,GFileAttributeMatcher_val, GFileAttributeMatcher_val, Val_GFileAttributeMatcher_new)
...
ML_2(g_desktop_app_info_get_show_in,GDesktopAppInfo_val, String_val, Val_bool)
ML_1(g_desktop_app_info_get_nodisplay,GDesktopAppInfo_val, Val_bool)
ML_1(g_desktop_app_info_get_is_hidden,GDesktopAppInfo_val, Val_bool)
ML_1(g_desktop_app_info_get_generic_name,GDesktopAppInfo_val, Val_string)
ML_1(g_desktop_app_info_get_filename,GDesktopAppInfo_val, Val_string)
ML_1(g_desktop_app_info_get_categories,GDesktopAppInfo_val, Val_string)
...
/* end of DBusServer */
/* Module DBusProxy */
ML_2(g_dbus_proxy_set_interface_info,GDBusProxy_val, Option_val(arg2,GDBusInterfaceInfo_val,NULL) Ignore, Unit)
ML_2(g_dbus_proxy_set_default_timeout,GDBusProxy_val, Int_val, Unit)
ML_3(g_dbus_proxy_set_cached_property,GDBusProxy_val, String_val, Option_val(arg3,GVariant_val,NULL) Ignore, Unit)
...
ML_2(g_dbus_object_skeleton_set_object_path,GDBusObjectSkeleton_val, String_val, Unit)
ML_2(g_dbus_object_skeleton_remove_interface_by_name,GDBusObjectSkeleton_val, String_val, Unit)
ML_2(g_dbus_object_skeleton_remove_interface,GDBusObjectSkeleton_val, GDBusInterfaceSkeleton_val, Unit)
ML_1(g_dbus_object_skeleton_flush,GDBusObjectSkeleton_val, Unit)
ML_2(g_dbus_object_skeleton_add_interface,GDBusObjectSkeleton_val, GDBusInterfaceSkeleton_val, Unit)
/* end of DBusObjectSkeleton */
/* Module DBusObjectProxy */
ML_1(g_dbus_object_proxy_get_connection,GDBusObjectProxy_val, Val_GDBusConnection)
/* end of DBusObjectProxy */
/* Module DBusObjectManagerServer */
ML_2(g_dbus_object_manager_server_unexport,GDBusObjectManagerServer_val, String_val, Val_bool)
ML_2(g_dbus_object_manager_server_set_connection,GDBusObjectManagerServer_val, Option_val(arg2,GDBusConnection_val,NULL) Ignore, Unit)
ML_1(g_dbus_object_manager_server_get_connection,GDBusObjectManagerServer_val, Val_GDBusConnection_new)
ML_2(g_dbus_object_manager_server_export_uniquely,GDBusObjectManagerServer_val, GDBusObjectSkeleton_val, Unit)
ML_2(g_dbus_object_manager_server_export,GDBusObjectManagerServer_val, GDBusObjectSkeleton_val, Unit)
/* end of DBusObjectManagerServer */
/* Module DBusObjectManagerClient */
ML_1(g_dbus_object_manager_client_get_name_owner,GDBusObjectManagerClient_val, Val_string_new)
ML_1(g_dbus_object_manager_client_get_name,GDBusObjectManagerClient_val, Val_string)
ML_1(g_dbus_object_manager_client_get_connection,GDBusObjectManagerClient_val, Val_GDBusConnection)
/* end of DBusObjectManagerClient */
/* Module DBusNodeInfo */
ML_1(g_dbus_node_info_unref,GDBusNodeInfo_val, Unit)
ML_1(g_dbus_node_info_ref,GDBusNodeInfo_val, Val_GDBusNodeInfo_new)
ML_2(g_dbus_node_info_lookup_interface,GDBusNodeInfo_val, String_val, Val_GDBusInterfaceInfo)
/* end of DBusNodeInfo */
/* Module DBusMethodInvocation */
ML_3(g_dbus_method_invocation_return_value_with_unix_fd_list,GDBusMethodInvocation_val, Option_val(arg2,GVariant_val,NULL) Ignore, Option_val(arg3,GUnixFDList_val,NULL) Ignore, Unit)
ML_2(g_dbus_method_invocation_return_value,GDBusMethodInvocation_val, Option_val(arg2,GVariant_val,NULL) Ignore, Unit)
...
ML_1(g_dbus_method_invocation_get_parameters,GDBusMethodInvocation_val, Val_GVariant)
...
ML_3(g_dbus_menu_model_get,GDBusConnection_val, String_val, String_val, Val_GDBusMenuModel_new)
/* end of DBusMenuModel */
/* Module DBusInterfaceSkeleton */
ML_2(g_dbus_interface_skeleton_unexport_from_connection,GDBusInterfaceSkeleton_val, GDBusConnection_val, Unit)
ML_1(g_dbus_interface_skeleton_unexport,GDBusInterfaceSkeleton_val, Unit)
ML_2(g_dbus_interface_skeleton_has_connection,GDBusInterfaceSkeleton_val, GDBusConnection_val, Val_bool)
ML_1(g_dbus_interface_skeleton_get_vtable,GDBusInterfaceSkeleton_val, Val_GDBusInterfaceVTable)
ML_1(g_dbus_interface_skeleton_get_properties,GDBusInterfaceSkeleton_val, Val_GVariant_new)
ML_1(g_dbus_interface_skeleton_get_object_path,GDBusInterfaceSkeleton_val, Val_string)
ML_1(g_dbus_interface_skeleton_get_info,GDBusInterfaceSkeleton_val, Val_GDBusInterfaceInfo)
ML_1(g_dbus_interface_skeleton_get_connections,GDBusInterfaceSkeleton_val, Val_GList_new)
ML_1(g_dbus_interface_skeleton_get_connection,GDBusInterfaceSkeleton_val, Val_GDBusConnection)
ML_1(g_dbus_interface_skeleton_flush,GDBusInterfaceSkeleton_val, Unit)
/* end of DBusInterfaceSkeleton */
...
ML_2(g_dbus_interface_info_lookup_signal,GDBusInterfaceInfo_val, String_val, Val_GDBusSignalInfo)
ML_2(g_dbus_interface_info_lookup_property,GDBusInterfaceInfo_val, String_val, Val_GDBusPropertyInfo)
ML_2(g_dbus_interface_info_lookup_method,GDBusInterfaceInfo_val, String_val, Val_GDBusMethodInfo)
ML_1(g_dbus_interface_info_cache_release,GDBusInterfaceInfo_val, Unit)
ML_1(g_dbus_interface_info_cache_build,GDBusInterfaceInfo_val, Unit)
...
ML_2(g_dbus_connection_unexport_menu_model,GDBusConnection_val, Int_val, Unit)
ML_2(g_dbus_connection_unexport_action_group,GDBusConnection_val, Int_val, Unit)
...
ML_3(g_dbus_action_group_get,GDBusConnection_val, String_val, String_val, Val_GDBusActionGroup_new)
/* end of DBusActionGroup */
/* Module Credentials */
...
ML_0(g_application_get_default,Val_GApplication)
/* end of Application */
/* Module AppLaunchContext */
ML_2(g_app_launch_context_unsetenv,GAppLaunchContext_val, String_val, Unit)
ML_3(g_app_launch_context_setenv,GAppLaunchContext_val, String_val, String_val, Unit)
...
ML_1(g_pollable_source_new,GObject_val, Val_GSource_new)
ML_0(g_io_scheduler_cancel_all_jobs,Unit)
ML_2(g_io_modules_scan_all_in_directory_with_scope,String_val, GIOModuleScope_val, Unit)
ML_1(g_io_modules_scan_all_in_directory,String_val, Unit)
ML_2(g_io_modules_load_all_in_directory_with_scope,String_val, GIOModuleScope_val, Val_GList_new)
...
ML_2(g_dbus_gvariant_to_gvalue,GVariant_val, GValue_val, Unit)
ML_2(g_dbus_gvalue_to_gvariant,GValue_val, GVariantType_val, Val_GVariant_new)
