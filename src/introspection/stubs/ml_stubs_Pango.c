...
/* end of ScriptIter */
/* Module Renderer */
ML_2(pango_renderer_set_matrix,PangoRenderer_val, Option_val(arg2,PangoMatrix_val,NULL) Ignore, Unit)
...
ML_5(pango_renderer_draw_glyph_item,PangoRenderer_val, Option_val(arg2,String_val,NULL) Ignore, PangoGlyphItem_val, Int_val, Int_val, Unit)
...
ML_2(pango_layout_set_tabs,PangoLayout_val, Option_val(arg2,PangoTabArray_val,NULL) Ignore, Unit)
...
ML_2(pango_layout_set_font_description,PangoLayout_val, Option_val(arg2,PangoFontDescription_val,NULL) Ignore, Unit)
...
ML_2(pango_layout_get_line_readonly,PangoLayout_val, Int_val, Val_PangoLayoutLine)
ML_1(pango_layout_get_line_count,PangoLayout_val, Val_int)
ML_2(pango_layout_get_line,PangoLayout_val, Int_val, Val_PangoLayoutLine)
...
ML_1(pango_layout_get_character_count,PangoLayout_val, Val_int)
...
ML_1(pango_language_from_string,Option_val(arg1,String_val,NULL) Ignore, Val_PangoLanguage_new)
/* end of Language */
/* Module Item */
...
ML_3(pango_glyph_item_apply_attrs,PangoGlyphItem_val, String_val, PangoAttrList_val, Val_GSList_new)
/* end of GlyphItem */
/* Module Fontset */
ML_1(pango_fontset_get_metrics,PangoFontset_val, Val_PangoFontMetrics_new)
ML_2(pango_fontset_get_font,PangoFontset_val, Int_val, Val_PangoFont_new)
/* end of Fontset */
/* Module FontMetrics */
...
/* end of FontMetrics */
/* Module FontMap */
ML_4(pango_font_map_load_fontset,PangoFontMap_val, PangoContext_val, PangoFontDescription_val, PangoLanguage_val, Val_PangoFontset_new)
ML_3(pango_font_map_load_font,PangoFontMap_val, PangoContext_val, PangoFontDescription_val, Val_PangoFont_new)
ML_1(pango_font_map_create_context,PangoFontMap_val, Val_PangoContext_new)
/* end of FontMap */
/* Module FontFamily */
...
ML_3(pango_font_description_merge,PangoFontDescription_val, Option_val(arg2,PangoFontDescription_val,NULL) Ignore, Bool_val, Unit)
...
ML_3(pango_font_description_better_match,PangoFontDescription_val, Option_val(arg2,PangoFontDescription_val,NULL) Ignore, PangoFontDescription_val, Val_bool)
ML_1(pango_font_description_from_string,String_val, Val_PangoFontDescription_new)
/* end of FontDescription */
/* Module Font */
ML_2(pango_font_get_metrics,PangoFont_val, Option_val(arg2,PangoLanguage_val,NULL) Ignore, Val_PangoFontMetrics_new)
...
/* end of Coverage */
/* Module Context */
ML_2(pango_context_set_matrix,PangoContext_val, Option_val(arg2,PangoMatrix_val,NULL) Ignore, Unit)
...
ML_3(pango_context_load_fontset,PangoContext_val, PangoFontDescription_val, PangoLanguage_val, Val_PangoFontset_new)
ML_2(pango_context_load_font,PangoContext_val, PangoFontDescription_val, Val_PangoFont_new)
ML_3(pango_context_get_metrics,PangoContext_val, Option_val(arg2,PangoFontDescription_val,NULL) Ignore, Option_val(arg3,PangoLanguage_val,NULL) Ignore, Val_PangoFontMetrics_new)
...
ML_1(pango_attr_iterator_get_attrs,PangoAttrIterator_val, Val_GSList_new)
...
ML_1(pango_reorder_items,GList_val, Val_GList_new)
ML_6(pango_itemize,PangoContext_val, String_val, Int_val, Int_val, PangoAttrList_val, Option_val(arg6,PangoAttrIterator_val,NULL) Ignore, Val_GList_new)
...
ML_2(pango_extents_to_pixels,Option_val(arg1,PangoRectangle_val,NULL) Ignore, Option_val(arg2,PangoRectangle_val,NULL) Ignore, Unit)
