...
/* Module ValueArray */
ML_2(g_value_array_remove,GValueArray_val, Int_val, Val_GValueArray)
ML_2(g_value_array_prepend,GValueArray_val, Option_val(arg2,GValue_val,NULL) Ignore, Val_GValueArray)
ML_3(g_value_array_insert,GValueArray_val, Int_val, Option_val(arg3,GValue_val,NULL) Ignore, Val_GValueArray)
ML_2(g_value_array_get_nth,GValueArray_val, Int_val, Val_GValue)
ML_1(g_value_array_free,GValueArray_val, Unit)
ML_1(g_value_array_copy,GValueArray_val, Val_GValueArray_new)
ML_2(g_value_array_append,GValueArray_val, Option_val(arg2,GValue_val,NULL) Ignore, Val_GValueArray)
/* end of ValueArray */
/* Module Value */
ML_1(g_value_unset,GValue_val, Unit)
ML_2(g_value_transform,GValue_val, GValue_val, Val_bool)
ML_2(g_value_take_variant,GValue_val, GVariant_val, Unit)
ML_2(g_value_take_string,GValue_val, String_val, Unit)
ML_2(g_value_take_param,GValue_val, GParamSpec_val, Unit)
ML_2(g_value_set_variant,GValue_val, GVariant_val, Unit)
ML_2(g_value_set_ulong,GValue_val, Double_val, Unit)
ML_2(g_value_set_uint64,GValue_val, Int64_val, Unit)
ML_2(g_value_set_uint,GValue_val, Int_val, Unit)
ML_2(g_value_set_uchar,GValue_val, Int_val, Unit)
ML_2(g_value_set_string_take_ownership,GValue_val, String_val, Unit)
ML_2(g_value_set_string,GValue_val, String_val, Unit)
ML_2(g_value_set_static_string,GValue_val, String_val, Unit)
ML_2(g_value_set_param_take_ownership,GValue_val, GParamSpec_val, Unit)
ML_2(g_value_set_param,GValue_val, GParamSpec_val, Unit)
ML_2(g_value_set_long,GValue_val, Double_val, Unit)
ML_2(g_value_set_int64,GValue_val, Int64_val, Unit)
ML_2(g_value_set_int,GValue_val, Int_val, Unit)
ML_2(g_value_set_gtype,GValue_val, Int_val, Unit)
ML_2(g_value_set_flags,GValue_val, Int_val, Unit)
ML_2(g_value_set_enum,GValue_val, Int_val, Unit)
ML_2(g_value_set_double,GValue_val, Double_val, Unit)
ML_2(g_value_set_char,GValue_val, Int_val, Unit)
ML_2(g_value_set_boolean,GValue_val, Bool_val, Unit)
ML_1(g_value_reset,GValue_val, Val_GValue_new)
ML_2(g_value_init,GValue_val, Int_val, Val_GValue)
ML_1(g_value_get_variant,GValue_val, Val_GVariant_new)
ML_1(g_value_get_ulong,GValue_val, Val_double)
ML_1(g_value_get_uint64,GValue_val, Val_int64)
ML_1(g_value_get_uint,GValue_val, Val_int)
ML_1(g_value_get_uchar,GValue_val, Val_int)
ML_1(g_value_get_string,GValue_val, Val_string)
ML_1(g_value_get_param,GValue_val, Val_GParamSpec)
ML_1(g_value_get_long,GValue_val, Val_double)
ML_1(g_value_get_int64,GValue_val, Val_int64)
ML_1(g_value_get_int,GValue_val, Val_int)
ML_1(g_value_get_gtype,GValue_val, Val_int)
ML_1(g_value_get_flags,GValue_val, Val_int)
ML_1(g_value_get_enum,GValue_val, Val_int)
ML_1(g_value_get_double,GValue_val, Val_double)
ML_1(g_value_get_char,GValue_val, Val_int)
ML_1(g_value_get_boolean,GValue_val, Val_bool)
ML_1(g_value_fits_pointer,GValue_val, Val_bool)
ML_1(g_value_dup_variant,GValue_val, Val_GVariant_new)
ML_1(g_value_dup_string,GValue_val, Val_string_new)
ML_1(g_value_dup_param,GValue_val, Val_GParamSpec)
ML_2(g_value_copy,GValue_val, GValue_val, Unit)
/* end of Value */
/* Module TypeValueTable */
/* end of TypeValueTable */
/* Module TypeQuery */
/* end of TypeQuery */
/* Module TypePluginClass */
/* end of TypePluginClass */
/* Module TypeModuleClass */
/* end of TypeModuleClass */
/* Module TypeModule */
ML_1(g_type_module_use,GTypeModule_val, Val_bool)
ML_1(g_type_module_unuse,GTypeModule_val, Unit)
ML_2(g_type_module_set_name,GTypeModule_val, String_val, Unit)
ML_3(g_type_module_register_flags,GTypeModule_val, String_val, GFlagsValue_val, Val_int)
ML_3(g_type_module_register_enum,GTypeModule_val, String_val, GEnumValue_val, Val_int)
ML_4(g_type_module_add_interface,GTypeModule_val, Int_val, Int_val, GInterfaceInfo_val, Unit)
/* end of TypeModule */
/* Module TypeInterface */
/* end of TypeInterface */
/* Module TypeInstance */
/* end of TypeInstance */
/* Module TypeInfo */
/* end of TypeInfo */
/* Module TypeFundamentalInfo */
/* end of TypeFundamentalInfo */
/* Module TypeClass */
ML_1(g_type_class_unref_uncached,GTypeClass_val, Unit)
ML_1(g_type_class_unref,GTypeClass_val, Unit)
/* end of TypeClass */
/* Module SignalQuery */
/* end of SignalQuery */
/* Module SignalInvocationHint */
/* end of SignalInvocationHint */
/* Module Parameter */
/* end of Parameter */
/* Module ParamSpecVariant */
/* end of ParamSpecVariant */
/* Module ParamSpecValueArray */
/* end of ParamSpecValueArray */
/* Module ParamSpecUnichar */
/* end of ParamSpecUnichar */
/* Module ParamSpecULong */
/* end of ParamSpecULong */
/* Module ParamSpecUInt64 */
/* end of ParamSpecUInt64 */
/* Module ParamSpecUInt */
/* end of ParamSpecUInt */
/* Module ParamSpecUChar */
/* end of ParamSpecUChar */
/* Module ParamSpecTypeInfo */
/* end of ParamSpecTypeInfo */
/* Module ParamSpecString */
/* end of ParamSpecString */
/* Module ParamSpecPool */
ML_2(g_param_spec_pool_remove,GParamSpecPool_val, GParamSpec_val, Unit)
ML_4(g_param_spec_pool_lookup,GParamSpecPool_val, String_val, Int_val, Bool_val, Val_GParamSpec)
ML_2(g_param_spec_pool_list_owned,GParamSpecPool_val, Int_val, Val_GList)
ML_3(g_param_spec_pool_insert,GParamSpecPool_val, GParamSpec_val, Int_val, Unit)
/* end of ParamSpecPool */
/* Module ParamSpecPointer */
/* end of ParamSpecPointer */
/* Module ParamSpecParam */
/* end of ParamSpecParam */
/* Module ParamSpecOverride */
/* end of ParamSpecOverride */
/* Module ParamSpecObject */
/* end of ParamSpecObject */
/* Module ParamSpecLong */
/* end of ParamSpecLong */
/* Module ParamSpecInt64 */
/* end of ParamSpecInt64 */
/* Module ParamSpecInt */
/* end of ParamSpecInt */
/* Module ParamSpecGType */
/* end of ParamSpecGType */
/* Module ParamSpecFloat */
/* end of ParamSpecFloat */
/* Module ParamSpecFlags */
/* end of ParamSpecFlags */
/* Module ParamSpecEnum */
/* end of ParamSpecEnum */
/* Module ParamSpecDouble */
/* end of ParamSpecDouble */
/* Module ParamSpecClass */
/* end of ParamSpecClass */
/* Module ParamSpecChar */
/* end of ParamSpecChar */
/* Module ParamSpecBoxed */
/* end of ParamSpecBoxed */
/* Module ParamSpecBoolean */
/* end of ParamSpecBoolean */
/* Module ParamSpec */
ML_1(g_param_spec_unref,GParamSpec_val, Unit)
ML_1(g_param_spec_sink,GParamSpec_val, Unit)
ML_1(g_param_spec_ref_sink,GParamSpec_val, Val_GParamSpec)
ML_1(g_param_spec_ref,GParamSpec_val, Val_GParamSpec)
ML_1(g_param_spec_get_redirect_target,GParamSpec_val, Val_GParamSpec)
ML_1(g_param_spec_get_nick,GParamSpec_val, Val_string)
ML_1(g_param_spec_get_name,GParamSpec_val, Val_string)
ML_1(g_param_spec_get_blurb,GParamSpec_val, Val_string)
/* end of ParamSpec */
/* Module ObjectConstructParam */
/* end of ObjectConstructParam */
/* Module ObjectClass */
ML_3(g_object_class_override_property,GObjectClass_val, Int_val, String_val, Unit)
ML_3(g_object_class_install_property,GObjectClass_val, Int_val, GParamSpec_val, Unit)
ML_2(g_object_class_find_property,GObjectClass_val, String_val, Val_GParamSpec)
/* end of ObjectClass */
/* Module Object */
/* end of Object */
/* Module InterfaceInfo */
/* end of InterfaceInfo */
/* Module InitiallyUnownedClass */
/* end of InitiallyUnownedClass */
/* Module InitiallyUnowned */
ML_0(g_object_type_init,Unit)
...
/* Module EnumClass */
/* end of EnumClass */
/* Module ClosureNotifyData */
/* end of ClosureNotifyData */
/* Module Closure */
ML_1(g_closure_unref,GClosure_val, Unit)
ML_1(g_closure_sink,GClosure_val, Unit)
ML_1(g_closure_ref,GClosure_val, Val_GClosure)
ML_1(g_closure_invalidate,GClosure_val, Unit)
/* end of Closure */
/* Module CClosure */
/* end of CClosure */
/* Module Binding */
ML_1(g_binding_get_target_property,GBinding_val, Val_string)
ML_1(g_binding_get_source_property,GBinding_val, Val_string)
/* end of Binding */
/* Global functions */
ML_0(g_variant_type_get_gtype,Val_int)
ML_0(g_variant_get_gtype,Val_int)
ML_0(g_value_types_init,Unit)
ML_2(g_value_type_transformable,Int_val, Int_val, Val_bool)
ML_2(g_value_type_compatible,Int_val, Int_val, Val_bool)
ML_0(g_value_transforms_init,Unit)
ML_0(g_value_c_init,Unit)
ML_1(g_type_value_table_peek,Int_val, Val_GTypeValueTable)
ML_2(g_type_test_flags,Int_val, Int_val, Val_bool)
ML_1(g_type_qname,Int_val, Val_int32)
ML_1(g_type_parent,Int_val, Val_int)
ML_2(g_type_next_base,Int_val, Int_val, Val_int)
ML_1(g_type_name_from_instance,GTypeInstance_val, Val_string)
ML_1(g_type_name_from_class,GTypeClass_val, Val_string)
ML_1(g_type_name,Int_val, Val_string)
ML_2(g_type_is_a,Int_val, Int_val, Val_bool)
ML_2(g_type_interface_add_prerequisite,Int_val, Int_val, Unit)
ML_0(g_type_init,Unit)
ML_0(g_type_fundamental_next,Val_int)
ML_1(g_type_fundamental,Int_val, Val_int)
ML_1(g_type_from_name,String_val, Val_int)
ML_1(g_type_free_instance,GTypeInstance_val, Unit)
ML_1(g_type_depth,Int_val, Val_int)
ML_1(g_type_create_instance,Int_val, Val_GTypeInstance)
ML_2(g_type_check_value_holds,GValue_val, Int_val, Val_bool)
ML_1(g_type_check_value,GValue_val, Val_bool)
ML_1(g_type_check_is_value_type,Int_val, Val_bool)
ML_2(g_type_check_instance_is_a,GTypeInstance_val, Int_val, Val_bool)
ML_2(g_type_check_instance_cast,GTypeInstance_val, Int_val, Val_GTypeInstance)
ML_1(g_type_check_instance,GTypeInstance_val, Val_bool)
ML_2(g_type_check_class_is_a,GTypeClass_val, Int_val, Val_bool)
ML_2(g_type_check_class_cast,GTypeClass_val, Int_val, Val_GTypeClass)
ML_3(g_type_add_interface_static,Int_val, Int_val, GInterfaceInfo_val, Unit)
ML_2(g_type_add_class_private,Int_val, Int_val, Unit)
ML_0(g_strv_get_type,Val_int)
ML_1(g_strdup_value_contents,GValue_val, Val_string_new)
ML_1(g_source_set_dummy_callback,GSource_val, Unit)
ML_2(g_source_set_closure,GSource_val, GClosure_val, Unit)
ML_2(g_signal_type_cclosure_new,Int_val, Int_val, Val_GClosure_new)
ML_2(g_signal_remove_emission_hook,Int_val, Double_val, Unit)
ML_2(g_signal_query,Int_val, GSignalQuery_val, Unit)
ML_3(g_signal_override_class_closure,Int_val, Int_val, GClosure_val, Unit)
ML_1(g_signal_name,Int_val, Val_string)
ML_2(g_signal_lookup,String_val, Int_val, Val_int)
ML_0(g_signal_init,Unit)
ML_4(g_signal_emitv,GValue_val, Int_val, Int32_val, GValue_val, Unit)
ML_2(g_signal_chain_from_overridden,GValue_val, GValue_val, Unit)
ML_1(g_pointer_type_register_static,String_val, Val_int)
ML_3(g_param_values_cmp,GParamSpec_val, GValue_val, GValue_val, Val_int)
ML_2(g_param_value_validate,GParamSpec_val, GValue_val, Val_bool)
ML_2(g_param_value_set_default,GParamSpec_val, GValue_val, Unit)
ML_2(g_param_value_defaults,GParamSpec_val, GValue_val, Val_bool)
ML_4(g_param_value_convert,GParamSpec_val, GValue_val, GValue_val, Bool_val, Val_bool)
ML_2(g_param_type_register_static,String_val, GParamSpecTypeInfo_val, Val_int)
ML_0(g_param_type_init,Unit)
ML_0(g_param_spec_types_init,Unit)
ML_1(g_param_spec_pool_new,Bool_val, Val_GParamSpecPool)
ML_2(g_param_spec_override,String_val, GParamSpec_val, Val_GParamSpec)
ML_0(g_object_get_type,Val_int)
ML_0(g_gtype_get_type,Val_int)
ML_2(g_flags_register_static,String_val, GFlagsValue_val, Val_int)
ML_2(g_flags_get_value_by_nick,GFlagsClass_val, String_val, Val_GFlagsValue)
ML_2(g_flags_get_value_by_name,GFlagsClass_val, String_val, Val_GFlagsValue)
ML_2(g_flags_get_first_value,GFlagsClass_val, Int_val, Val_GFlagsValue)
ML_3(g_flags_complete_type_info,Int_val, GTypeInfo_val, GFlagsValue_val, Unit)
ML_0(g_enum_types_init,Unit)
ML_2(g_enum_register_static,String_val, GEnumValue_val, Val_int)
ML_2(g_enum_get_value_by_nick,GEnumClass_val, String_val, Val_GEnumValue)
ML_2(g_enum_get_value_by_name,GEnumClass_val, String_val, Val_GEnumValue)
ML_2(g_enum_get_value,GEnumClass_val, Int_val, Val_GEnumValue)
ML_3(g_enum_complete_type_info,Int_val, GTypeInfo_val, GEnumValue_val, Unit)
ML_0(g_boxed_type_init,Unit)
