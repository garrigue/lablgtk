...
/* Module WindowRedirect */
/* end of WindowRedirect */
/* Module WindowClass */
/* end of WindowClass */
/* Module WindowAttr */
/* end of WindowAttr */
/* Module Window */
ML_1(gdk_window_withdraw,GdkWindow_val, Unit)
ML_1(gdk_window_unstick,GdkWindow_val, Unit)
ML_1(gdk_window_unmaximize,GdkWindow_val, Unit)
ML_1(gdk_window_unfullscreen,GdkWindow_val, Unit)
ML_1(gdk_window_thaw_updates,GdkWindow_val, Unit)
ML_1(gdk_window_thaw_toplevel_updates_libgtk_only,GdkWindow_val, Unit)
ML_1(gdk_window_stick,GdkWindow_val, Unit)
ML_1(gdk_window_show_unraised,GdkWindow_val, Unit)
ML_1(gdk_window_show,GdkWindow_val, Unit)
ML_4(gdk_window_shape_combine_region,GdkWindow_val, cairo_region_t_val, Int_val, Int_val, Unit)
ML_2(gdk_window_set_urgency_hint,GdkWindow_val, Bool_val, Unit)
ML_2(gdk_window_set_transient_for,GdkWindow_val, GdkWindow_val, Unit)
ML_2(gdk_window_set_title,GdkWindow_val, String_val, Unit)
ML_2(gdk_window_set_support_multidevice,GdkWindow_val, Bool_val, Unit)
ML_2(gdk_window_set_static_gravities,GdkWindow_val, Bool_val, Val_bool)
ML_2(gdk_window_set_startup_id,GdkWindow_val, String_val, Unit)
ML_2(gdk_window_set_skip_taskbar_hint,GdkWindow_val, Bool_val, Unit)
ML_2(gdk_window_set_skip_pager_hint,GdkWindow_val, Bool_val, Unit)
ML_2(gdk_window_set_role,GdkWindow_val, String_val, Unit)
ML_2(gdk_window_set_override_redirect,GdkWindow_val, Bool_val, Unit)
ML_2(gdk_window_set_opacity,GdkWindow_val, Double_val, Unit)
ML_2(gdk_window_set_modal_hint,GdkWindow_val, Bool_val, Unit)
ML_2(gdk_window_set_keep_below,GdkWindow_val, Bool_val, Unit)
ML_2(gdk_window_set_keep_above,GdkWindow_val, Bool_val, Unit)
ML_2(gdk_window_set_icon_name,GdkWindow_val, String_val, Unit)
ML_2(gdk_window_set_icon_list,GdkWindow_val, GList_val, Unit)
ML_2(gdk_window_set_group,GdkWindow_val, GdkWindow_val, Unit)
ML_2(gdk_window_set_focus_on_map,GdkWindow_val, Bool_val, Unit)
ML_3(gdk_window_set_device_cursor,GdkWindow_val, GdkDevice_val, GdkCursor_val, Unit)
ML_2(gdk_window_set_cursor,GdkWindow_val, Option_val(arg2,GdkCursor_val,NULL) Ignore, Unit)
ML_2(gdk_window_set_composited,GdkWindow_val, Bool_val, Unit)
ML_1(gdk_window_set_child_shapes,GdkWindow_val, Unit)
ML_1(gdk_window_set_child_input_shapes,GdkWindow_val, Unit)
ML_2(gdk_window_set_background_rgba,GdkWindow_val, GdkRGBA_val, Unit)
ML_2(gdk_window_set_background_pattern,GdkWindow_val, Option_val(arg2,cairo_pattern_t_val,NULL) Ignore, Unit)
ML_2(gdk_window_set_background,GdkWindow_val, GdkColor_val, Unit)
ML_2(gdk_window_set_accept_focus,GdkWindow_val, Bool_val, Unit)
ML_3(gdk_window_scroll,GdkWindow_val, Int_val, Int_val, Unit)
ML_3(gdk_window_restack,GdkWindow_val, Option_val(arg2,GdkWindow_val,NULL) Ignore, Bool_val, Unit)
ML_3(gdk_window_resize,GdkWindow_val, Int_val, Int_val, Unit)
ML_4(gdk_window_reparent,GdkWindow_val, GdkWindow_val, Int_val, Int_val, Unit)
ML_1(gdk_window_register_dnd,GdkWindow_val, Unit)
ML_1(gdk_window_raise,GdkWindow_val, Unit)
ML_2(gdk_window_process_updates,GdkWindow_val, Bool_val, Unit)
ML_1(gdk_window_peek_children,GdkWindow_val, Val_GList)
ML_5(gdk_window_move_resize,GdkWindow_val, Int_val, Int_val, Int_val, Int_val, Unit)
ML_4(gdk_window_move_region,GdkWindow_val, cairo_region_t_val, Int_val, Int_val, Unit)
ML_3(gdk_window_move,GdkWindow_val, Int_val, Int_val, Unit)
ML_1(gdk_window_merge_child_shapes,GdkWindow_val, Unit)
ML_1(gdk_window_merge_child_input_shapes,GdkWindow_val, Unit)
ML_1(gdk_window_maximize,GdkWindow_val, Unit)
ML_1(gdk_window_lower,GdkWindow_val, Unit)
ML_1(gdk_window_is_visible,GdkWindow_val, Val_bool)
ML_1(gdk_window_is_viewable,GdkWindow_val, Val_bool)
ML_1(gdk_window_is_shaped,GdkWindow_val, Val_bool)
ML_1(gdk_window_is_input_only,GdkWindow_val, Val_bool)
ML_1(gdk_window_is_destroyed,GdkWindow_val, Val_bool)
ML_3(gdk_window_invalidate_region,GdkWindow_val, cairo_region_t_val, Bool_val, Unit)
ML_4(gdk_window_input_shape_combine_region,GdkWindow_val, cairo_region_t_val, Int_val, Int_val, Unit)
ML_1(gdk_window_iconify,GdkWindow_val, Unit)
ML_1(gdk_window_hide,GdkWindow_val, Unit)
ML_1(gdk_window_has_native,GdkWindow_val, Val_bool)
ML_1(gdk_window_get_width,GdkWindow_val, Val_int)
ML_1(gdk_window_get_visual,GdkWindow_val, Val_GdkVisual)
ML_1(gdk_window_get_visible_region,GdkWindow_val, Val_cairo_region_t_new)
ML_1(gdk_window_get_update_area,GdkWindow_val, Val_cairo_region_t_new)
ML_1(gdk_window_get_toplevel,GdkWindow_val, Val_GdkWindow)
ML_1(gdk_window_get_support_multidevice,GdkWindow_val, Val_bool)
ML_1(gdk_window_get_screen,GdkWindow_val, Val_GdkScreen)
ML_1(gdk_window_get_parent,GdkWindow_val, Val_GdkWindow)
ML_1(gdk_window_get_modal_hint,GdkWindow_val, Val_bool)
ML_1(gdk_window_get_height,GdkWindow_val, Val_int)
ML_1(gdk_window_get_group,GdkWindow_val, Val_GdkWindow)
ML_1(gdk_window_get_focus_on_map,GdkWindow_val, Val_bool)
ML_1(gdk_window_get_effective_toplevel,GdkWindow_val, Val_GdkWindow)
ML_1(gdk_window_get_effective_parent,GdkWindow_val, Val_GdkWindow)
ML_1(gdk_window_get_display,GdkWindow_val, Val_GdkDisplay)
ML_2(gdk_window_get_device_cursor,GdkWindow_val, GdkDevice_val, Val_GdkCursor)
ML_1(gdk_window_get_cursor,GdkWindow_val, Val_GdkCursor)
ML_1(gdk_window_get_composited,GdkWindow_val, Val_bool)
ML_1(gdk_window_get_clip_region,GdkWindow_val, Val_cairo_region_t_new)
ML_1(gdk_window_get_children,GdkWindow_val, Val_GList)
ML_1(gdk_window_get_background_pattern,GdkWindow_val, Val_cairo_pattern_t)
ML_1(gdk_window_get_accept_focus,GdkWindow_val, Val_bool)
ML_1(gdk_window_geometry_changed,GdkWindow_val, Unit)
ML_1(gdk_window_fullscreen,GdkWindow_val, Unit)
ML_1(gdk_window_freeze_updates,GdkWindow_val, Unit)
ML_1(gdk_window_freeze_toplevel_updates_libgtk_only,GdkWindow_val, Unit)
ML_2(gdk_window_focus,GdkWindow_val, Int32_val, Unit)
ML_1(gdk_window_flush,GdkWindow_val, Unit)
ML_1(gdk_window_ensure_native,GdkWindow_val, Val_bool)
ML_1(gdk_window_end_paint,GdkWindow_val, Unit)
ML_1(gdk_window_enable_synchronized_configure,GdkWindow_val, Unit)
ML_1(gdk_window_destroy_notify,GdkWindow_val, Unit)
ML_1(gdk_window_destroy,GdkWindow_val, Unit)
ML_1(gdk_window_deiconify,GdkWindow_val, Unit)
ML_1(gdk_window_configure_finished,GdkWindow_val, Unit)
ML_2(gdk_window_begin_paint_region,GdkWindow_val, cairo_region_t_val, Unit)
ML_5(gdk_window_begin_move_drag,GdkWindow_val, Int_val, Int_val, Int_val, Int32_val, Unit)
ML_1(gdk_window_beep,GdkWindow_val, Unit)
ML_1(gdk_window_set_debug_updates,Bool_val, Unit)
ML_0(gdk_window_process_all_updates,Unit)
/* end of Window */
/* Module Visual */
ML_1(gdk_visual_get_screen,GdkVisual_val, Val_GdkScreen)
ML_1(gdk_visual_get_depth,GdkVisual_val, Val_int)
ML_1(gdk_visual_get_colormap_size,GdkVisual_val, Val_int)
ML_1(gdk_visual_get_bits_per_rgb,GdkVisual_val, Val_int)
ML_0(gdk_visual_get_system,Val_GdkVisual)
ML_1(gdk_visual_get_best_with_depth,Int_val, Val_GdkVisual)
ML_0(gdk_visual_get_best_depth,Val_int)
ML_0(gdk_visual_get_best,Val_GdkVisual)
/* end of Visual */
/* Module TimeCoord */
/* end of TimeCoord */
/* Module Screen */
ML_2(gdk_screen_set_resolution,GdkScreen_val, Double_val, Unit)
ML_2(gdk_screen_set_font_options,GdkScreen_val, Option_val(arg2,cairo_font_options_t_val,NULL) Ignore, Unit)
ML_1(gdk_screen_make_display_name,GdkScreen_val, Val_string_new)
ML_1(gdk_screen_list_visuals,GdkScreen_val, Val_GList)
ML_1(gdk_screen_is_composited,GdkScreen_val, Val_bool)
ML_1(gdk_screen_get_window_stack,GdkScreen_val, Val_GList_new)
ML_1(gdk_screen_get_width_mm,GdkScreen_val, Val_int)
ML_1(gdk_screen_get_width,GdkScreen_val, Val_int)
ML_1(gdk_screen_get_toplevel_windows,GdkScreen_val, Val_GList)
ML_1(gdk_screen_get_system_visual,GdkScreen_val, Val_GdkVisual)
ML_3(gdk_screen_get_setting,GdkScreen_val, String_val, GValue_val, Val_bool)
ML_1(gdk_screen_get_root_window,GdkScreen_val, Val_GdkWindow)
ML_1(gdk_screen_get_rgba_visual,GdkScreen_val, Val_GdkVisual)
ML_1(gdk_screen_get_resolution,GdkScreen_val, Val_double)
ML_1(gdk_screen_get_primary_monitor,GdkScreen_val, Val_int)
ML_1(gdk_screen_get_number,GdkScreen_val, Val_int)
ML_1(gdk_screen_get_n_monitors,GdkScreen_val, Val_int)
ML_2(gdk_screen_get_monitor_width_mm,GdkScreen_val, Int_val, Val_int)
ML_2(gdk_screen_get_monitor_plug_name,GdkScreen_val, Int_val, Val_string_new)
ML_2(gdk_screen_get_monitor_height_mm,GdkScreen_val, Int_val, Val_int)
ML_2(gdk_screen_get_monitor_at_window,GdkScreen_val, GdkWindow_val, Val_int)
ML_3(gdk_screen_get_monitor_at_point,GdkScreen_val, Int_val, Int_val, Val_int)
ML_1(gdk_screen_get_height_mm,GdkScreen_val, Val_int)
ML_1(gdk_screen_get_height,GdkScreen_val, Val_int)
ML_1(gdk_screen_get_font_options,GdkScreen_val, Val_cairo_font_options_t)
ML_1(gdk_screen_get_display,GdkScreen_val, Val_GdkDisplay)
ML_1(gdk_screen_get_active_window,GdkScreen_val, Val_GdkWindow_new)
...
/* end of Screen */
/* Module RGBA */
ML_1(gdk_rgba_to_string,GdkRGBA_val, Val_string_new)
ML_2(gdk_rgba_parse,GdkRGBA_val, String_val, Val_bool)
ML_1(gdk_rgba_hash,GdkRGBA_val, Val_int)
ML_1(gdk_rgba_free,GdkRGBA_val, Unit)
ML_1(gdk_rgba_copy,GdkRGBA_val, Val_GdkRGBA_new)
/* end of RGBA */
/* Module Point */
/* end of Point */
/* Module KeymapKey */
/* end of KeymapKey */
/* Module Keymap */
ML_2(gdk_keymap_lookup_key,GdkKeymap_val, GdkKeymapKey_val, Val_int)
ML_1(gdk_keymap_have_bidi_layouts,GdkKeymap_val, Val_bool)
ML_1(gdk_keymap_get_num_lock_state,GdkKeymap_val, Val_bool)
ML_1(gdk_keymap_get_caps_lock_state,GdkKeymap_val, Val_bool)
ML_1(gdk_keymap_get_for_display,GdkDisplay_val, Val_GdkKeymap)
ML_0(gdk_keymap_get_default,Val_GdkKeymap)
/* end of Keymap */
/* Module Geometry */
/* end of Geometry */
/* Module EventWindowState */
/* end of EventWindowState */
/* Module EventVisibility */
/* end of EventVisibility */
/* Module EventSetting */
/* end of EventSetting */
/* Module EventSelection */
/* end of EventSelection */
/* Module EventScroll */
/* end of EventScroll */
/* Module EventProximity */
/* end of EventProximity */
/* Module EventProperty */
/* end of EventProperty */
/* Module EventOwnerChange */
/* end of EventOwnerChange */
/* Module EventMotion */
/* end of EventMotion */
/* Module EventKey */
/* end of EventKey */
/* Module EventGrabBroken */
/* end of EventGrabBroken */
/* Module EventFocus */
/* end of EventFocus */
/* Module EventExpose */
/* end of EventExpose */
/* Module EventDND */
/* end of EventDND */
/* Module EventCrossing */
/* end of EventCrossing */
/* Module EventConfigure */
/* end of EventConfigure */
/* Module EventButton */
/* end of EventButton */
/* Module EventAny */
/* end of EventAny */
/* Module DragContext */
ML_2(gdk_drag_context_set_device,GdkDragContext_val, GdkDevice_val, Unit)
ML_1(gdk_drag_context_list_targets,GdkDragContext_val, Val_GList)
ML_1(gdk_drag_context_get_source_window,GdkDragContext_val, Val_GdkWindow)
ML_1(gdk_drag_context_get_device,GdkDragContext_val, Val_GdkDevice)
ML_1(gdk_drag_context_get_dest_window,GdkDragContext_val, Val_GdkWindow)
/* end of DragContext */
/* Module DisplayManager */
ML_2(gdk_display_manager_set_default_display,GdkDisplayManager_val, GdkDisplay_val, Unit)
ML_2(gdk_display_manager_open_display,GdkDisplayManager_val, String_val, Val_GdkDisplay)
ML_1(gdk_display_manager_list_displays,GdkDisplayManager_val, Val_GSList)
ML_1(gdk_display_manager_get_default_display,GdkDisplayManager_val, Val_GdkDisplay)
ML_0(gdk_display_manager_get,Val_GdkDisplayManager)
/* end of DisplayManager */
/* Module Display */
ML_4(gdk_display_warp_pointer,GdkDisplay_val, GdkScreen_val, Int_val, Int_val, Unit)
ML_1(gdk_display_sync,GdkDisplay_val, Unit)
ML_1(gdk_display_supports_shapes,GdkDisplay_val, Val_bool)
ML_1(gdk_display_supports_selection_notification,GdkDisplay_val, Val_bool)
ML_1(gdk_display_supports_input_shapes,GdkDisplay_val, Val_bool)
ML_1(gdk_display_supports_cursor_color,GdkDisplay_val, Val_bool)
ML_1(gdk_display_supports_cursor_alpha,GdkDisplay_val, Val_bool)
ML_1(gdk_display_supports_composite,GdkDisplay_val, Val_bool)
ML_1(gdk_display_supports_clipboard_persistence,GdkDisplay_val, Val_bool)
ML_2(gdk_display_set_double_click_time,GdkDisplay_val, Int_val, Unit)
ML_2(gdk_display_set_double_click_distance,GdkDisplay_val, Int_val, Unit)
ML_2(gdk_display_pointer_ungrab,GdkDisplay_val, Int32_val, Unit)
ML_1(gdk_display_pointer_is_grabbed,GdkDisplay_val, Val_bool)
ML_2(gdk_display_notify_startup_complete,GdkDisplay_val, String_val, Unit)
ML_1(gdk_display_list_devices,GdkDisplay_val, Val_GList)
ML_2(gdk_display_keyboard_ungrab,GdkDisplay_val, Int32_val, Unit)
ML_1(gdk_display_is_closed,GdkDisplay_val, Val_bool)
ML_1(gdk_display_has_pending,GdkDisplay_val, Val_bool)
ML_2(gdk_display_get_screen,GdkDisplay_val, Int_val, Val_GdkScreen)
ML_1(gdk_display_get_name,GdkDisplay_val, Val_string)
ML_1(gdk_display_get_n_screens,GdkDisplay_val, Val_int)
ML_1(gdk_display_get_device_manager,GdkDisplay_val, Val_GdkDeviceManager)
ML_1(gdk_display_get_default_screen,GdkDisplay_val, Val_GdkScreen)
ML_1(gdk_display_get_default_group,GdkDisplay_val, Val_GdkWindow)
ML_1(gdk_display_get_default_cursor_size,GdkDisplay_val, Val_int)
ML_1(gdk_display_get_app_launch_context,GdkDisplay_val, Val_GdkAppLaunchContext_new)
ML_1(gdk_display_flush,GdkDisplay_val, Unit)
ML_2(gdk_display_device_is_grabbed,GdkDisplay_val, GdkDevice_val, Val_bool)
ML_1(gdk_display_close,GdkDisplay_val, Unit)
ML_1(gdk_display_beep,GdkDisplay_val, Unit)
ML_0(gdk_display_open_default_libgtk_only,Val_GdkDisplay)
ML_1(gdk_display_open,String_val, Val_GdkDisplay)
ML_0(gdk_display_get_default,Val_GdkDisplay)
/* end of Display */
/* Module DeviceManager */
ML_1(gdk_device_manager_get_display,GdkDeviceManager_val, Val_GdkDisplay)
ML_1(gdk_device_manager_get_client_pointer,GdkDeviceManager_val, Val_GdkDevice)
/* end of DeviceManager */
/* Module Device */
ML_4(gdk_device_warp,GdkDevice_val, GdkScreen_val, Int_val, Int_val, Unit)
ML_2(gdk_device_ungrab,GdkDevice_val, Int32_val, Unit)
ML_1(gdk_device_list_slave_devices,GdkDevice_val, Val_GList)
ML_1(gdk_device_list_axes,GdkDevice_val, Val_GList)
ML_1(gdk_device_get_name,GdkDevice_val, Val_string)
ML_1(gdk_device_get_n_keys,GdkDevice_val, Val_int)
ML_1(gdk_device_get_n_axes,GdkDevice_val, Val_int)
ML_1(gdk_device_get_has_cursor,GdkDevice_val, Val_bool)
ML_1(gdk_device_get_display,GdkDevice_val, Val_GdkDisplay)
ML_1(gdk_device_get_associated_device,GdkDevice_val, Val_GdkDevice)
/* end of Device */
/* Module Cursor */
ML_1(gdk_cursor_unref,GdkCursor_val, Unit)
ML_1(gdk_cursor_ref,GdkCursor_val, Val_GdkCursor_new)
ML_1(gdk_cursor_get_image,GdkCursor_val, Val_GdkPixbuf_new)
ML_1(gdk_cursor_get_display,GdkCursor_val, Val_GdkDisplay)
/* end of Cursor */
/* Module Color */
ML_1(gdk_color_to_string,GdkColor_val, Val_string_new)
ML_1(gdk_color_hash,GdkColor_val, Val_int)
ML_1(gdk_color_free,GdkColor_val, Unit)
ML_2(gdk_color_equal,GdkColor_val, GdkColor_val, Val_bool)
ML_1(gdk_color_copy,GdkColor_val, Val_GdkColor_new)
/* end of Color */
/* Module Atom */
/* end of Atom */
/* Module AppLaunchContext */
ML_2(gdk_app_launch_context_set_timestamp,GdkAppLaunchContext_val, Int32_val, Unit)
ML_2(gdk_app_launch_context_set_screen,GdkAppLaunchContext_val, GdkScreen_val, Unit)
ML_2(gdk_app_launch_context_set_icon_name,GdkAppLaunchContext_val, Option_val(arg2,String_val,NULL) Ignore, Unit)
ML_2(gdk_app_launch_context_set_display,GdkAppLaunchContext_val, GdkDisplay_val, Unit)
ML_2(gdk_app_launch_context_set_desktop,GdkAppLaunchContext_val, Int_val, Unit)
/* end of AppLaunchContext */
/* Global functions */
ML_1(gdk_utf8_to_string_target,String_val, Val_string_new)
ML_1(gdk_unicode_to_keyval,Int32_val, Val_int)
ML_0(gdk_threads_leave,Unit)
ML_0(gdk_threads_init,Unit)
ML_0(gdk_threads_enter,Unit)
ML_1(gdk_test_render_sync,GdkWindow_val, Unit)
ML_2(gdk_setting_get,String_val, GValue_val, Val_bool)
ML_1(gdk_set_show_events,Bool_val, Unit)
ML_1(gdk_set_program_class,String_val, Unit)
ML_1(gdk_set_double_click_time,Int_val, Unit)
ML_0(gdk_rectangle_get_type,Val_int)
ML_0(gdk_pre_parse_libgtk_only,Unit)
ML_1(gdk_pointer_ungrab,Int32_val, Unit)
ML_0(gdk_pointer_is_grabbed,Val_bool)
ML_5(gdk_pixbuf_get_from_window,GdkWindow_val, Int_val, Int_val, Int_val, Int_val, Val_GdkPixbuf_new)
ML_5(gdk_pixbuf_get_from_surface,cairo_surface_t_val, Int_val, Int_val, Int_val, Int_val, Val_GdkPixbuf_new)
ML_1(gdk_pango_context_get_for_screen,GdkScreen_val, Val_PangoContext_new)
ML_0(gdk_pango_context_get,Val_PangoContext_new)
ML_2(gdk_offscreen_window_set_embedder,GdkWindow_val, GdkWindow_val, Unit)
ML_1(gdk_offscreen_window_get_surface,GdkWindow_val, Val_cairo_surface_t)
ML_1(gdk_offscreen_window_get_embedder,GdkWindow_val, Val_GdkWindow)
ML_1(gdk_notify_startup_complete_with_id,String_val, Unit)
ML_0(gdk_notify_startup_complete,Unit)
ML_0(gdk_list_visuals,Val_GList)
ML_1(gdk_keyval_to_upper,Int_val, Val_int)
ML_1(gdk_keyval_to_unicode,Int_val, Val_int32)
ML_1(gdk_keyval_to_lower,Int_val, Val_int)
ML_1(gdk_keyval_name,Int_val, Val_string)
ML_1(gdk_keyval_is_upper,Int_val, Val_bool)
ML_1(gdk_keyval_is_lower,Int_val, Val_bool)
ML_1(gdk_keyval_from_name,String_val, Val_int)
ML_1(gdk_keyboard_ungrab,Int32_val, Unit)
ML_0(gdk_get_show_events,Val_bool)
ML_0(gdk_get_program_class,Val_string)
ML_0(gdk_get_display_arg_name,Val_string)
ML_0(gdk_get_display,Val_string_new)
ML_0(gdk_get_default_root_window,Val_GdkWindow)
ML_0(gdk_flush,Unit)
ML_0(gdk_events_pending,Val_bool)
ML_1(gdk_event_request_motions,GdkEventMotion_val, Unit)
ML_0(gdk_error_trap_push,Unit)
ML_0(gdk_error_trap_pop_ignored,Unit)
ML_0(gdk_error_trap_pop,Val_int)
ML_3(gdk_drop_reply,GdkDragContext_val, Bool_val, Int32_val, Unit)
ML_3(gdk_drop_finish,GdkDragContext_val, Bool_val, Int32_val, Unit)
ML_1(gdk_drag_drop_succeeded,GdkDragContext_val, Val_bool)
ML_2(gdk_drag_drop,GdkDragContext_val, Int32_val, Unit)
ML_3(gdk_drag_begin_for_device,GdkWindow_val, GdkDevice_val, GList_val, Val_GdkDragContext_new)
ML_2(gdk_drag_begin,GdkWindow_val, GList_val, Val_GdkDragContext_new)
ML_2(gdk_drag_abort,GdkDragContext_val, Int32_val, Unit)
ML_0(gdk_disable_multidevice,Unit)
ML_4(gdk_cairo_set_source_window,cairo_t_val, GdkWindow_val, Double_val, Double_val, Unit)
ML_2(gdk_cairo_set_source_rgba,cairo_t_val, GdkRGBA_val, Unit)
ML_4(gdk_cairo_set_source_pixbuf,cairo_t_val, GdkPixbuf_val, Double_val, Double_val, Unit)
ML_2(gdk_cairo_set_source_color,cairo_t_val, GdkColor_val, Unit)
ML_1(gdk_cairo_region_create_from_surface,cairo_surface_t_val, Val_cairo_region_t_new)
ML_2(gdk_cairo_region,cairo_t_val, cairo_region_t_val, Unit)
ML_1(gdk_cairo_create,GdkWindow_val, Val_cairo_t_new)
ML_0(gdk_beep,Unit)
ML_1(gdk_add_option_entries_libgtk_only,GOptionGroup_val, Unit)
