...
ML_1(g_variant_type_new_maybe,GVariantType_val, Val_GVariantType_new)
ML_2(g_variant_type_new_dict_entry,GVariantType_val, GVariantType_val, Val_GVariantType_new)
ML_1(g_variant_type_new_array,GVariantType_val, Val_GVariantType_new)
...
ML_1(g_variant_type_hash,GVariantType_val, Val_int)
...
ML_1(g_variant_type_copy,GVariantType_val, Val_GVariantType_new)
...
ML_1(g_variant_iter_copy,GVariantIter_val, Val_GVariantIter_new)
/* end of VariantIter */
/* Module VariantBuilder */
ML_1(g_variant_builder_unref,GVariantBuilder_val, Unit)
ML_1(g_variant_builder_ref,GVariantBuilder_val, Val_GVariantBuilder_new)
...
ML_1(g_variant_take_ref,GVariant_val, Val_GVariant_new)
ML_1(g_variant_ref_sink,GVariant_val, Val_GVariant_new)
ML_1(g_variant_ref,GVariant_val, Val_GVariant_new)
ML_3(g_variant_print_string,GVariant_val, Option_val(arg2,GString_val,NULL) Ignore, Bool_val, Val_GString_new)
ML_2(g_variant_print,GVariant_val, Bool_val, Val_string_new)
ML_1(g_variant_n_children,GVariant_val, Val_int)
ML_3(g_variant_lookup_value,GVariant_val, String_val, Option_val(arg3,GVariantType_val,NULL) Ignore, Val_GVariant_new)
ML_1(g_variant_iter_new,GVariant_val, Val_GVariantIter_new)
...
ML_1(g_variant_hash,GVariant_val, Val_int)
...
ML_1(g_time_zone_new,Option_val(arg1,String_val,NULL) Ignore, Val_GTimeZone)
/* end of TimeZone */
/* Module TimeVal */
...
/* end of ThreadPool */
/* Module Thread */
ML_1(g_thread_unref,GThread_val, Unit)
ML_1(g_thread_ref,GThread_val, Val_GThread)
ML_0(g_thread_yield,Unit)
...
/* end of StringChunk */
/* Module String */
ML_1(g_string_up,GString_val, Val_GString_new)
ML_2(g_string_truncate,GString_val, Int_val, Val_GString_new)
ML_2(g_string_set_size,GString_val, Int_val, Val_GString_new)
ML_2(g_string_prepend_unichar,GString_val, Int32_val, Val_GString_new)
ML_3(g_string_prepend_len,GString_val, String_val, Int_val, Val_GString_new)
ML_2(g_string_prepend_c,GString_val, Int_val, Val_GString_new)
ML_2(g_string_prepend,GString_val, String_val, Val_GString_new)
ML_4(g_string_overwrite_len,GString_val, Int_val, String_val, Int_val, Val_GString_new)
ML_3(g_string_overwrite,GString_val, Int_val, String_val, Val_GString_new)
ML_3(g_string_insert_unichar,GString_val, Int_val, Int32_val, Val_GString_new)
ML_4(g_string_insert_len,GString_val, Int_val, String_val, Int_val, Val_GString_new)
ML_3(g_string_insert_c,GString_val, Int_val, Int_val, Val_GString_new)
ML_3(g_string_insert,GString_val, Int_val, String_val, Val_GString_new)
ML_1(g_string_hash,GString_val, Val_int)
ML_2(g_string_free,GString_val, Bool_val, Val_string_new)
ML_3(g_string_erase,GString_val, Int_val, Int_val, Val_GString_new)
ML_2(g_string_equal,GString_val, GString_val, Val_bool)
ML_1(g_string_down,GString_val, Val_GString_new)
ML_2(g_string_assign,GString_val, String_val, Val_GString_new)
ML_1(g_string_ascii_up,GString_val, Val_GString_new)
ML_1(g_string_ascii_down,GString_val, Val_GString_new)
ML_4(g_string_append_uri_escaped,GString_val, String_val, String_val, Bool_val, Val_GString_new)
ML_2(g_string_append_unichar,GString_val, Int32_val, Val_GString_new)
ML_3(g_string_append_len,GString_val, String_val, Int_val, Val_GString_new)
ML_2(g_string_append_c,GString_val, Int_val, Val_GString_new)
ML_2(g_string_append,GString_val, String_val, Val_GString_new)
/* end of String */
/* Module Source */
...
ML_1(g_source_ref,GSource_val, Val_GSource_new)
...
ML_2(g_source_attach,GSource_val, Option_val(arg2,GMainContext_val,NULL) Ignore, Val_int)
...
ML_1(g_regex_ref,GRegex_val, Val_GRegex_new)
...
ML_2(g_regex_escape_nul,String_val, Int_val, Val_string_new)
ML_0(g_regex_error_quark,Val_int32)
/* end of Regex */
/* Module RecMutex */
ML_1(g_rec_mutex_unlock,GRecMutex_val, Unit)
ML_1(g_rec_mutex_trylock,GRecMutex_val, Val_bool)
ML_1(g_rec_mutex_lock,GRecMutex_val, Unit)
ML_1(g_rec_mutex_init,GRecMutex_val, Unit)
ML_1(g_rec_mutex_clear,GRecMutex_val, Unit)
/* end of RecMutex */
/* Module Rand */
...
/* end of Rand */
/* Module RWLock */
ML_1(g_rw_lock_writer_unlock,GRWLock_val, Unit)
ML_1(g_rw_lock_writer_trylock,GRWLock_val, Val_bool)
ML_1(g_rw_lock_writer_lock,GRWLock_val, Unit)
ML_1(g_rw_lock_reader_unlock,GRWLock_val, Unit)
ML_1(g_rw_lock_reader_trylock,GRWLock_val, Val_bool)
ML_1(g_rw_lock_reader_lock,GRWLock_val, Unit)
ML_1(g_rw_lock_init,GRWLock_val, Unit)
ML_1(g_rw_lock_clear,GRWLock_val, Unit)
/* end of RWLock */
/* Module Queue */
...
/* end of Node */
/* Module MatchInfo */
ML_1(g_match_info_unref,GMatchInfo_val, Unit)
ML_1(g_match_info_ref,GMatchInfo_val, Val_GMatchInfo_new)
...
ML_1(g_match_info_get_regex,GMatchInfo_val, Val_GRegex_new)
...
ML_1(g_main_loop_ref,GMainLoop_val, Val_GMainLoop_new)
...
ML_1(g_main_context_ref,GMainContext_val, Val_GMainContext_new)
...
ML_0(g_main_context_ref_thread_default,Val_GMainContext_new)
...
/* end of List */
/* Module KeyFile */
ML_1(g_key_file_unref,GKeyFile_val, Unit)
...
ML_1(g_key_file_ref,GKeyFile_val, Val_GKeyFile_new)
...
ML_1(g_io_channel_ref,GIOChannel_val, Val_GIOChannel_new)
...
/* end of IOChannel */
/* Module IConv */
ML_1(g_iconv_close,GIConv_val, Val_int)
/* end of IConv */
/* Module HookList */
...
/* end of Hook */
/* Module Hmac */
ML_1(g_hmac_unref,GHmac_val, Unit)
ML_1(g_hmac_ref,GHmac_val, Val_GHmac)
ML_1(g_hmac_get_string,GHmac_val, Val_string)
ML_1(g_hmac_copy,GHmac_val, Val_GHmac)
/* end of Hmac */
...
ML_1(g_error_copy,GError_val, Val_GError_new)
/* end of Error */
/* Module Dir */
...
ML_1(g_date_time_to_utc,GDateTime_val, Val_GDateTime_new)
ML_1(g_date_time_to_unix,GDateTime_val, Val_int64)
ML_2(g_date_time_to_timezone,GDateTime_val, GTimeZone_val, Val_GDateTime_new)
ML_2(g_date_time_to_timeval,GDateTime_val, GTimeVal_val, Val_bool)
ML_1(g_date_time_to_local,GDateTime_val, Val_GDateTime_new)
ML_1(g_date_time_ref,GDateTime_val, Val_GDateTime_new)
...
ML_2(g_date_time_add_years,GDateTime_val, Int_val, Val_GDateTime_new)
ML_2(g_date_time_add_weeks,GDateTime_val, Int_val, Val_GDateTime_new)
ML_2(g_date_time_add_seconds,GDateTime_val, Double_val, Val_GDateTime_new)
ML_2(g_date_time_add_months,GDateTime_val, Int_val, Val_GDateTime_new)
ML_2(g_date_time_add_minutes,GDateTime_val, Int_val, Val_GDateTime_new)
ML_2(g_date_time_add_hours,GDateTime_val, Int_val, Val_GDateTime_new)
ML_7(g_date_time_add_full,GDateTime_val, Int_val, Int_val, Int_val, Int_val, Int_val, Double_val, Val_GDateTime_new)
ML_bc7(ml_g_date_time_add_full)
ML_2(g_date_time_add_days,GDateTime_val, Int_val, Val_GDateTime_new)
ML_2(g_date_time_add,GDateTime_val, Int64_val, Val_GDateTime_new)
/* end of DateTime */
/* Module Date */
...
/* end of Date */
/* Module Cond */
ML_1(g_cond_signal,GCond_val, Unit)
ML_1(g_cond_init,GCond_val, Unit)
ML_1(g_cond_clear,GCond_val, Unit)
ML_1(g_cond_broadcast,GCond_val, Unit)
/* end of Cond */
/* Module Checksum */
...
/* end of Checksum */
/* Module Bytes */
ML_1(g_bytes_unref,GBytes_val, Unit)
ML_1(g_bytes_ref,GBytes_val, Val_GBytes_new)
ML_3(g_bytes_new_from_bytes,GBytes_val, Int_val, Int_val, Val_GBytes_new)
ML_1(g_bytes_hash,GBytes_val, Val_int)
ML_1(g_bytes_get_size,GBytes_val, Val_int)
/* end of Bytes */
/* Module ByteArray */
/* end of ByteArray */
/* Module BookmarkFile */
...
ML_3(g_utf8_substring,String_val, Double_val, Double_val, Val_string_new)
...
ML_3(g_uri_unescape_segment,Option_val(arg1,String_val,NULL) Ignore, Option_val(arg2,String_val,NULL) Ignore, Option_val(arg3,String_val,NULL) Ignore, Val_string_new)
...
ML_1(g_timeout_source_new_seconds,Int_val, Val_GSource_new)
ML_1(g_timeout_source_new,Int_val, Val_GSource_new)
...
ML_1(g_string_sized_new,Int_val, Val_GString_new)
ML_2(g_string_new_len,String_val, Int_val, Val_GString_new)
ML_1(g_string_new,String_val, Val_GString_new)
...
ML_1(g_quark_try_string,Option_val(arg1,String_val,NULL) Ignore, Val_int32)
ML_1(g_quark_to_string,Int32_val, Val_string)
ML_1(g_quark_from_string,Option_val(arg1,String_val,NULL) Ignore, Val_int32)
ML_1(g_quark_from_static_string,Option_val(arg1,String_val,NULL) Ignore, Val_int32)
...
ML_2(g_mkdtemp_full,String_val, Int_val, Val_string_new)
ML_1(g_mkdtemp,String_val, Val_string_new)
...
ML_1(g_intern_string,Option_val(arg1,String_val,NULL) Ignore, Val_string)
ML_1(g_intern_static_string,Option_val(arg1,String_val,NULL) Ignore, Val_string)
ML_0(g_idle_source_new,Val_GSource_new)
...
ML_0(g_get_codeset,Val_string_new)
ML_0(g_get_application_name,Val_string)
ML_1(g_format_size,Int64_val, Val_string_new)
...
ML_3(g_dcgettext,Option_val(arg1,String_val,NULL) Ignore, String_val, Int_val, Val_string)
ML_0(g_convert_error_quark,Val_int32)
ML_1(g_child_watch_source_new,Int_val, Val_GSource_new)
