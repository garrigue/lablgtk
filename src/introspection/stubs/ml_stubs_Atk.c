...
ML_2(atk_object_factory_create_accessible,AtkObjectFactory_val, GObject_val, Val_AtkObject_new)
...
ML_1(atk_gobject_accessible_get_object,AtkGObjectAccessible_val, Val_GObject)
ML_1(atk_gobject_accessible_for_object,GObject_val, Val_AtkObject)
