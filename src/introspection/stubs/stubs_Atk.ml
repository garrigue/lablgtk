...
module ObjectFactory = struct
  ...
  external create_accessible: [>`atkobjectfactory] obj -> [>`gobject] obj -> [<`atkobject] obj = "ml_atk_object_factory_create_accessible"
  end
...
module GObjectAccessible = struct
  external get_object: [>`atkgobjectaccessible] obj -> [<`gobject] obj = "ml_atk_gobject_accessible_get_object"
  external for_object: [>`gobject] obj -> [<`atkobject] obj = "ml_atk_gobject_accessible_for_object"
  end
