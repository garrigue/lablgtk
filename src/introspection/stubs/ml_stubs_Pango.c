...
/* Module _ScriptForLang */
/* end of _ScriptForLang */
/* Module TabArray */
ML_2(pango_tab_array_resize,PangoTabArray_val, Int_val, Unit)
ML_1(pango_tab_array_get_size,PangoTabArray_val, Val_int)
ML_1(pango_tab_array_get_positions_in_pixels,PangoTabArray_val, Val_bool)
ML_1(pango_tab_array_free,PangoTabArray_val, Unit)
ML_1(pango_tab_array_copy,PangoTabArray_val, Val_PangoTabArray_new)
/* end of TabArray */
/* Module ScriptIter */
ML_1(pango_script_iter_next,PangoScriptIter_val, Val_bool)
ML_1(pango_script_iter_free,PangoScriptIter_val, Unit)
/* end of ScriptIter */
/* Module RendererPrivate */
/* end of RendererPrivate */
/* Module RendererClass */
/* end of RendererClass */
/* Module Renderer */
ML_2(pango_renderer_set_matrix,PangoRenderer_val, PangoMatrix_val, Unit)
ML_1(pango_renderer_get_matrix,PangoRenderer_val, Val_PangoMatrix)
ML_1(pango_renderer_get_layout_line,PangoRenderer_val, Val_PangoLayoutLine_new)
ML_1(pango_renderer_get_layout,PangoRenderer_val, Val_PangoLayout)
ML_4(pango_renderer_draw_layout_line,PangoRenderer_val, PangoLayoutLine_val, Int_val, Int_val, Unit)
ML_4(pango_renderer_draw_layout,PangoRenderer_val, PangoLayout_val, Int_val, Int_val, Unit)
ML_5(pango_renderer_draw_glyphs,PangoRenderer_val, PangoFont_val, PangoGlyphString_val, Int_val, Int_val, Unit)
ML_5(pango_renderer_draw_glyph_item,PangoRenderer_val, String_val, PangoGlyphItem_val, Int_val, Int_val, Unit)
ML_5(pango_renderer_draw_glyph,PangoRenderer_val, PangoFont_val, Int32_val, Double_val, Double_val, Unit)
ML_5(pango_renderer_draw_error_underline,PangoRenderer_val, Int_val, Int_val, Int_val, Int_val, Unit)
ML_1(pango_renderer_deactivate,PangoRenderer_val, Unit)
ML_1(pango_renderer_activate,PangoRenderer_val, Unit)
/* end of Renderer */
/* Module Rectangle */
/* end of Rectangle */
/* Module Matrix */
ML_3(pango_matrix_translate,PangoMatrix_val, Double_val, Double_val, Unit)
ML_2(pango_matrix_transform_rectangle,PangoMatrix_val, PangoRectangle_val, Unit)
ML_2(pango_matrix_transform_pixel_rectangle,PangoMatrix_val, PangoRectangle_val, Unit)
ML_3(pango_matrix_scale,PangoMatrix_val, Double_val, Double_val, Unit)
ML_2(pango_matrix_rotate,PangoMatrix_val, Double_val, Unit)
ML_1(pango_matrix_get_font_scale_factor,PangoMatrix_val, Val_double)
ML_1(pango_matrix_free,PangoMatrix_val, Unit)
ML_1(pango_matrix_copy,PangoMatrix_val, Val_PangoMatrix_new)
ML_2(pango_matrix_concat,PangoMatrix_val, PangoMatrix_val, Unit)
/* end of Matrix */
/* Module LogAttr */
/* end of LogAttr */
/* Module LayoutLine */
ML_1(pango_layout_line_unref,PangoLayoutLine_val, Unit)
ML_1(pango_layout_line_ref,PangoLayoutLine_val, Val_PangoLayoutLine_new)
ML_3(pango_layout_line_get_pixel_extents,PangoLayoutLine_val, PangoRectangle_val, PangoRectangle_val, Unit)
ML_3(pango_layout_line_get_extents,PangoLayoutLine_val, PangoRectangle_val, PangoRectangle_val, Unit)
/* end of LayoutLine */
/* Module LayoutIter */
ML_1(pango_layout_iter_next_run,PangoLayoutIter_val, Val_bool)
ML_1(pango_layout_iter_next_line,PangoLayoutIter_val, Val_bool)
ML_1(pango_layout_iter_next_cluster,PangoLayoutIter_val, Val_bool)
ML_1(pango_layout_iter_next_char,PangoLayoutIter_val, Val_bool)
ML_3(pango_layout_iter_get_run_extents,PangoLayoutIter_val, PangoRectangle_val, PangoRectangle_val, Unit)
ML_1(pango_layout_iter_get_line_readonly,PangoLayoutIter_val, Val_PangoLayoutLine_new)
ML_3(pango_layout_iter_get_line_extents,PangoLayoutIter_val, PangoRectangle_val, PangoRectangle_val, Unit)
ML_1(pango_layout_iter_get_line,PangoLayoutIter_val, Val_PangoLayoutLine_new)
ML_3(pango_layout_iter_get_layout_extents,PangoLayoutIter_val, PangoRectangle_val, PangoRectangle_val, Unit)
ML_1(pango_layout_iter_get_layout,PangoLayoutIter_val, Val_PangoLayout)
ML_1(pango_layout_iter_get_index,PangoLayoutIter_val, Val_int)
ML_3(pango_layout_iter_get_cluster_extents,PangoLayoutIter_val, PangoRectangle_val, PangoRectangle_val, Unit)
ML_2(pango_layout_iter_get_char_extents,PangoLayoutIter_val, PangoRectangle_val, Unit)
ML_1(pango_layout_iter_get_baseline,PangoLayoutIter_val, Val_int)
ML_1(pango_layout_iter_free,PangoLayoutIter_val, Unit)
ML_1(pango_layout_iter_copy,PangoLayoutIter_val, Val_PangoLayoutIter_new)
ML_1(pango_layout_iter_at_last_line,PangoLayoutIter_val, Val_bool)
/* end of LayoutIter */
/* Module LayoutClass */
/* end of LayoutClass */
/* Module Layout */
ML_2(pango_layout_set_width,PangoLayout_val, Int_val, Unit)
ML_3(pango_layout_set_text,PangoLayout_val, String_val, Int_val, Unit)
ML_2(pango_layout_set_tabs,PangoLayout_val, PangoTabArray_val, Unit)
...
ML_3(pango_layout_set_markup,PangoLayout_val, String_val, Int_val, Unit)
ML_2(pango_layout_set_justify,PangoLayout_val, Bool_val, Unit)
ML_2(pango_layout_set_indent,PangoLayout_val, Int_val, Unit)
ML_2(pango_layout_set_height,PangoLayout_val, Int_val, Unit)
ML_2(pango_layout_set_font_description,PangoLayout_val, PangoFontDescription_val, Unit)
ML_2(pango_layout_set_auto_dir,PangoLayout_val, Bool_val, Unit)
ML_2(pango_layout_set_attributes,PangoLayout_val, PangoAttrList_val, Unit)
ML_1(pango_layout_is_wrapped,PangoLayout_val, Val_bool)
ML_1(pango_layout_is_ellipsized,PangoLayout_val, Val_bool)
ML_3(pango_layout_index_to_pos,PangoLayout_val, Int_val, PangoRectangle_val, Unit)
ML_1(pango_layout_get_width,PangoLayout_val, Val_int)
ML_1(pango_layout_get_unknown_glyphs_count,PangoLayout_val, Val_int)
ML_1(pango_layout_get_text,PangoLayout_val, Val_string)
ML_1(pango_layout_get_tabs,PangoLayout_val, Val_PangoTabArray_new)
...
ML_3(pango_layout_get_pixel_extents,PangoLayout_val, PangoRectangle_val, PangoRectangle_val, Unit)
ML_1(pango_layout_get_lines_readonly,PangoLayout_val, Val_GSList)
ML_1(pango_layout_get_lines,PangoLayout_val, Val_GSList)
ML_2(pango_layout_get_line_readonly,PangoLayout_val, Int_val, Val_PangoLayoutLine_new)
ML_1(pango_layout_get_line_count,PangoLayout_val, Val_int)
ML_2(pango_layout_get_line,PangoLayout_val, Int_val, Val_PangoLayoutLine_new)
ML_1(pango_layout_get_justify,PangoLayout_val, Val_bool)
ML_1(pango_layout_get_iter,PangoLayout_val, Val_PangoLayoutIter_new)
ML_1(pango_layout_get_indent,PangoLayout_val, Val_int)
ML_1(pango_layout_get_height,PangoLayout_val, Val_int)
ML_1(pango_layout_get_font_description,PangoLayout_val, Val_PangoFontDescription)
ML_3(pango_layout_get_extents,PangoLayout_val, PangoRectangle_val, PangoRectangle_val, Unit)
ML_4(pango_layout_get_cursor_pos,PangoLayout_val, Int_val, PangoRectangle_val, PangoRectangle_val, Unit)
ML_1(pango_layout_get_context,PangoLayout_val, Val_PangoContext)
ML_1(pango_layout_get_baseline,PangoLayout_val, Val_int)
ML_1(pango_layout_get_auto_dir,PangoLayout_val, Val_bool)
ML_1(pango_layout_get_attributes,PangoLayout_val, Val_PangoAttrList_new)
ML_1(pango_layout_copy,PangoLayout_val, Val_PangoLayout)
ML_1(pango_layout_context_changed,PangoLayout_val, Unit)
/* end of Layout */
/* Module Language */
ML_1(pango_language_to_string,PangoLanguage_val, Val_string)
ML_2(pango_language_matches,PangoLanguage_val, String_val, Val_bool)
ML_1(pango_language_get_sample_string,PangoLanguage_val, Val_string)
/* end of Language */
/* Module Item */
ML_3(pango_item_split,PangoItem_val, Int_val, Int_val, Val_PangoItem_new)
ML_1(pango_item_free,PangoItem_val, Unit)
ML_1(pango_item_copy,PangoItem_val, Val_PangoItem_new)
/* end of Item */
/* Module GlyphVisAttr */
/* end of GlyphVisAttr */
/* Module GlyphString */
ML_2(pango_glyph_string_set_size,PangoGlyphString_val, Int_val, Unit)
ML_1(pango_glyph_string_get_width,PangoGlyphString_val, Val_int)
ML_1(pango_glyph_string_free,PangoGlyphString_val, Unit)
ML_6(pango_glyph_string_extents_range,PangoGlyphString_val, Int_val, Int_val, PangoFont_val, PangoRectangle_val, PangoRectangle_val, Unit)
ML_bc6(ml_pango_glyph_string_extents_range)
ML_4(pango_glyph_string_extents,PangoGlyphString_val, PangoFont_val, PangoRectangle_val, PangoRectangle_val, Unit)
ML_1(pango_glyph_string_copy,PangoGlyphString_val, Val_PangoGlyphString_new)
/* end of GlyphString */
/* Module GlyphItemIter */
ML_1(pango_glyph_item_iter_prev_cluster,PangoGlyphItemIter_val, Val_bool)
ML_1(pango_glyph_item_iter_next_cluster,PangoGlyphItemIter_val, Val_bool)
ML_3(pango_glyph_item_iter_init_start,PangoGlyphItemIter_val, PangoGlyphItem_val, String_val, Val_bool)
ML_3(pango_glyph_item_iter_init_end,PangoGlyphItemIter_val, PangoGlyphItem_val, String_val, Val_bool)
ML_1(pango_glyph_item_iter_free,PangoGlyphItemIter_val, Unit)
ML_1(pango_glyph_item_iter_copy,PangoGlyphItemIter_val, Val_PangoGlyphItemIter_new)
/* end of GlyphItemIter */
/* Module GlyphItem */
ML_3(pango_glyph_item_split,PangoGlyphItem_val, String_val, Int_val, Val_PangoGlyphItem_new)
ML_4(pango_glyph_item_letter_space,PangoGlyphItem_val, String_val, PangoLogAttr_val, Int_val, Unit)
ML_1(pango_glyph_item_free,PangoGlyphItem_val, Unit)
ML_1(pango_glyph_item_copy,PangoGlyphItem_val, Val_PangoGlyphItem_new)
ML_3(pango_glyph_item_apply_attrs,PangoGlyphItem_val, String_val, PangoAttrList_val, Val_GSList)
/* end of GlyphItem */
/* Module GlyphInfo */
/* end of GlyphInfo */
/* Module GlyphGeometry */
/* end of GlyphGeometry */
/* Module Fontset */
ML_1(pango_fontset_get_metrics,PangoFontset_val, Val_PangoFontMetrics_new)
ML_2(pango_fontset_get_font,PangoFontset_val, Int_val, Val_PangoFont)
/* end of Fontset */
/* Module FontMetrics */
ML_1(pango_font_metrics_unref,PangoFontMetrics_val, Unit)
ML_1(pango_font_metrics_ref,PangoFontMetrics_val, Val_PangoFontMetrics_new)
ML_1(pango_font_metrics_get_underline_thickness,PangoFontMetrics_val, Val_int)
ML_1(pango_font_metrics_get_underline_position,PangoFontMetrics_val, Val_int)
ML_1(pango_font_metrics_get_strikethrough_thickness,PangoFontMetrics_val, Val_int)
ML_1(pango_font_metrics_get_strikethrough_position,PangoFontMetrics_val, Val_int)
...
/* end of FontMetrics */
/* Module FontMap */
ML_4(pango_font_map_load_fontset,PangoFontMap_val, PangoContext_val, PangoFontDescription_val, PangoLanguage_val, Val_PangoFontset)
ML_3(pango_font_map_load_font,PangoFontMap_val, PangoContext_val, PangoFontDescription_val, Val_PangoFont)
ML_1(pango_font_map_create_context,PangoFontMap_val, Val_PangoContext)
/* end of FontMap */
/* Module FontFamily */
ML_1(pango_font_family_is_monospace,PangoFontFamily_val, Val_bool)
ML_1(pango_font_family_get_name,PangoFontFamily_val, Val_string)
/* end of FontFamily */
/* Module FontFace */
ML_1(pango_font_face_is_synthesized,PangoFontFace_val, Val_bool)
ML_1(pango_font_face_get_face_name,PangoFontFace_val, Val_string)
ML_1(pango_font_face_describe,PangoFontFace_val, Val_PangoFontDescription_new)
/* end of FontFace */
/* Module FontDescription */
ML_1(pango_font_description_to_string,PangoFontDescription_val, Val_string_new)
ML_1(pango_font_description_to_filename,PangoFontDescription_val, Val_string_new)
ML_2(pango_font_description_set_size,PangoFontDescription_val, Int_val, Unit)
ML_2(pango_font_description_set_family_static,PangoFontDescription_val, String_val, Unit)
...
ML_3(pango_font_description_merge_static,PangoFontDescription_val, PangoFontDescription_val, Bool_val, Unit)
ML_3(pango_font_description_merge,PangoFontDescription_val, PangoFontDescription_val, Bool_val, Unit)
ML_1(pango_font_description_hash,PangoFontDescription_val, Val_int)
...
ML_1(pango_font_description_get_family,PangoFontDescription_val, Val_string)
ML_1(pango_font_description_free,PangoFontDescription_val, Unit)
ML_2(pango_font_description_equal,PangoFontDescription_val, PangoFontDescription_val, Val_bool)
ML_1(pango_font_description_copy_static,PangoFontDescription_val, Val_PangoFontDescription_new)
ML_1(pango_font_description_copy,PangoFontDescription_val, Val_PangoFontDescription_new)
ML_3(pango_font_description_better_match,PangoFontDescription_val, PangoFontDescription_val, PangoFontDescription_val, Val_bool)
/* end of FontDescription */
/* Module Font */
ML_2(pango_font_get_metrics,PangoFont_val, PangoLanguage_val, Val_PangoFontMetrics_new)
ML_4(pango_font_get_glyph_extents,PangoFont_val, Int32_val, PangoRectangle_val, PangoRectangle_val, Unit)
ML_1(pango_font_get_font_map,PangoFont_val, Val_PangoFontMap)
ML_2(pango_font_get_coverage,PangoFont_val, PangoLanguage_val, Val_PangoCoverage)
ML_3(pango_font_find_shaper,PangoFont_val, PangoLanguage_val, Int32_val, Val_PangoEngineShape)
ML_1(pango_font_describe_with_absolute_size,PangoFont_val, Val_PangoFontDescription_new)
ML_1(pango_font_describe,PangoFont_val, Val_PangoFontDescription_new)
/* end of Font */
/* Module EngineShape */
/* end of EngineShape */
/* Module EngineLang */
/* end of EngineLang */
/* Module Coverage */
ML_1(pango_coverage_unref,PangoCoverage_val, Unit)
ML_1(pango_coverage_ref,PangoCoverage_val, Val_PangoCoverage)
ML_2(pango_coverage_max,PangoCoverage_val, PangoCoverage_val, Unit)
ML_1(pango_coverage_copy,PangoCoverage_val, Val_PangoCoverage)
/* end of Coverage */
/* Module ContextClass */
/* end of ContextClass */
/* Module Context */
ML_2(pango_context_set_matrix,PangoContext_val, PangoMatrix_val, Unit)
ML_2(pango_context_set_language,PangoContext_val, PangoLanguage_val, Unit)
ML_2(pango_context_set_font_map,PangoContext_val, PangoFontMap_val, Unit)
ML_2(pango_context_set_font_description,PangoContext_val, PangoFontDescription_val, Unit)
ML_3(pango_context_load_fontset,PangoContext_val, PangoFontDescription_val, PangoLanguage_val, Val_PangoFontset)
ML_2(pango_context_load_font,PangoContext_val, PangoFontDescription_val, Val_PangoFont)
ML_3(pango_context_get_metrics,PangoContext_val, PangoFontDescription_val, PangoLanguage_val, Val_PangoFontMetrics_new)
ML_1(pango_context_get_matrix,PangoContext_val, Val_PangoMatrix)
ML_1(pango_context_get_language,PangoContext_val, Val_PangoLanguage_new)
ML_1(pango_context_get_font_map,PangoContext_val, Val_PangoFontMap)
ML_1(pango_context_get_font_description,PangoContext_val, Val_PangoFontDescription_new)
/* end of Context */
/* Module Color */
ML_1(pango_color_to_string,PangoColor_val, Val_string_new)
ML_2(pango_color_parse,PangoColor_val, String_val, Val_bool)
ML_1(pango_color_free,PangoColor_val, Unit)
ML_1(pango_color_copy,PangoColor_val, Val_PangoColor_new)
/* end of Color */
/* Module Attribute */
ML_2(pango_attribute_init,PangoAttribute_val, PangoAttrClass_val, Unit)
ML_2(pango_attribute_equal,PangoAttribute_val, PangoAttribute_val, Val_bool)
ML_1(pango_attribute_destroy,PangoAttribute_val, Unit)
ML_1(pango_attribute_copy,PangoAttribute_val, Val_PangoAttribute)
/* end of Attribute */
/* Module AttrString */
/* end of AttrString */
/* Module AttrSize */
...
/* end of AttrShape */
/* Module AttrList */
ML_1(pango_attr_list_unref,PangoAttrList_val, Unit)
ML_4(pango_attr_list_splice,PangoAttrList_val, PangoAttrList_val, Int_val, Int_val, Unit)
ML_1(pango_attr_list_ref,PangoAttrList_val, Val_PangoAttrList_new)
ML_2(pango_attr_list_insert_before,PangoAttrList_val, PangoAttribute_val, Unit)
ML_2(pango_attr_list_insert,PangoAttrList_val, PangoAttribute_val, Unit)
ML_1(pango_attr_list_get_iterator,PangoAttrList_val, Val_PangoAttrIterator)
ML_1(pango_attr_list_copy,PangoAttrList_val, Val_PangoAttrList_new)
ML_2(pango_attr_list_change,PangoAttrList_val, PangoAttribute_val, Unit)
/* end of AttrList */
/* Module AttrLanguage */
/* end of AttrLanguage */
/* Module AttrIterator */
ML_1(pango_attr_iterator_next,PangoAttrIterator_val, Val_bool)
ML_1(pango_attr_iterator_get_attrs,PangoAttrIterator_val, Val_GSList)
ML_1(pango_attr_iterator_destroy,PangoAttrIterator_val, Unit)
ML_1(pango_attr_iterator_copy,PangoAttrIterator_val, Val_PangoAttrIterator)
/* end of AttrIterator */
/* Module AttrInt */
/* end of AttrInt */
/* Module AttrFontDesc */
...
/* end of Analysis */
/* Global functions */
ML_0(pango_version_string,Val_string)
ML_3(pango_version_check,Int_val, Int_val, Int_val, Val_string)
ML_0(pango_version,Val_int)
ML_1(pango_units_to_double,Int_val, Val_double)
ML_1(pango_units_from_double,Double_val, Val_int)
ML_1(pango_trim_string,String_val, Val_string_new)
ML_4(pango_shape,String_val, Int_val, PangoAnalysis_val, PangoGlyphString_val, Unit)
ML_2(pango_script_iter_new,String_val, Int_val, Val_PangoScriptIter)
ML_1(pango_reorder_items,GList_val, Val_GList)
ML_0(pango_language_get_default,Val_PangoLanguage_new)
ML_1(pango_language_from_string,String_val, Val_PangoLanguage_new)
ML_6(pango_itemize,PangoContext_val, String_val, Int_val, Int_val, PangoAttrList_val, PangoAttrIterator_val, Val_GList)
ML_bc6(ml_pango_itemize)
ML_1(pango_is_zero_width,Int32_val, Val_bool)
ML_6(pango_get_log_attrs,String_val, Int_val, Int_val, PangoLanguage_val, PangoLogAttr_val, Int_val, Unit)
ML_bc6(ml_pango_get_log_attrs)
ML_1(pango_font_description_from_string,String_val, Val_PangoFontDescription_new)
ML_2(pango_extents_to_pixels,PangoRectangle_val, PangoRectangle_val, Unit)
ML_0(pango_coverage_new,Val_PangoCoverage)
ML_2(pango_coverage_from_bytes,String_val, Int_val, Val_PangoCoverage)
ML_5(pango_break,String_val, Int_val, PangoAnalysis_val, PangoLogAttr_val, Int_val, Unit)
ML_3(pango_attr_underline_color_new,Int_val, Int_val, Int_val, Val_PangoAttribute)
ML_1(pango_attr_strikethrough_new,Bool_val, Val_PangoAttribute)
ML_3(pango_attr_strikethrough_color_new,Int_val, Int_val, Int_val, Val_PangoAttribute)
ML_1(pango_attr_size_new_absolute,Int_val, Val_PangoAttribute)
ML_1(pango_attr_size_new,Int_val, Val_PangoAttribute)
ML_2(pango_attr_shape_new,PangoRectangle_val, PangoRectangle_val, Val_PangoAttribute)
ML_1(pango_attr_scale_new,Double_val, Val_PangoAttribute)
ML_1(pango_attr_rise_new,Int_val, Val_PangoAttribute)
ML_1(pango_attr_letter_spacing_new,Int_val, Val_PangoAttribute)
ML_1(pango_attr_language_new,PangoLanguage_val, Val_PangoAttribute)
ML_3(pango_attr_foreground_new,Int_val, Int_val, Int_val, Val_PangoAttribute)
ML_1(pango_attr_font_desc_new,PangoFontDescription_val, Val_PangoAttribute)
ML_1(pango_attr_family_new,String_val, Val_PangoAttribute)
ML_1(pango_attr_fallback_new,Bool_val, Val_PangoAttribute)
ML_3(pango_attr_background_new,Int_val, Int_val, Int_val, Val_PangoAttribute)
