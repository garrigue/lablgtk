...
ML_4(gdk_window_shape_combine_region,GdkWindow_val, Option_val(arg2,cairo_region_t_val,NULL) Ignore, Int_val, Int_val, Unit)
...
ML_2(gdk_window_set_icon_name,GdkWindow_val, Option_val(arg2,String_val,NULL) Ignore, Unit)
ML_2(gdk_window_set_icon_list,GdkWindow_val, GList_val, Unit)
ML_2(gdk_window_set_group,GdkWindow_val, Option_val(arg2,GdkWindow_val,NULL) Ignore, Unit)
...
ML_6(gdk_window_begin_move_drag_for_device,GdkWindow_val, GdkDevice_val, Int_val, Int_val, Int_val, Int32_val, Unit)
ML_bc6(ml_gdk_window_begin_move_drag_for_device)
...
ML_1(gdk_keymap_get_modifier_state,GdkKeymap_val, Val_int)
...
/* end of Color */
/* Module Atom */
ML_1(gdk_atom_name,GdkAtom_val, Val_string_new)
/* end of Atom */
